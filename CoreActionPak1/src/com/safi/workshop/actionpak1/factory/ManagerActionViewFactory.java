 ...
 * @generated
 */
public class ManagerActionViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(ManagerActionEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(ManagerActionNameEditPart.VISUAL_ID), ViewUtil.APPEND,
        true, getPreferencesHint());
//    getViewService().createNode(eObjectAdapter, view,
//        AsteriskVisualIDRegistry.getType(PropertyMappingItemPanelEditPart.VISUAL_ID),
