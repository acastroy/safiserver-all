...
import com.safi.workshop.actionpak1.command.OutputItemCreateCommand;
import com.safi.workshop.edit.policies.ActionstepCreateCommandFactory;

public class ManagerActionCreateCommandFactory implements
		ActionstepCreateCommandFactory {
	...
	public CreateElementCommand getCreateCommand(CreateElementRequest req) {
		...
		else if (req.getElementType() == ElementTypes.elementType_OutputItem_50002)
			return new OutputItemCreateCommand(req);
		// else if (req.getElementType() ==
		// ElementTypes.elementType_PropertyMappingItem_50003)
