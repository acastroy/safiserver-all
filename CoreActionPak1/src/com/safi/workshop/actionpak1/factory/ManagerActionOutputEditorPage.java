...
//    bindingContext.bindList(uiList, modelList, null, null);
//    
//    returnVarDVEWidget.setItemList(uiList);
//    returnVarDVEWidget.setActionstepEditorDialog(parent);
  }
...
//        return (List)((CallWSByWSDLEditPart)editPart).getCallWSByWSDLModel().getOutputParameters();
//      }
//      
//      @Override
//      protected ItemPanelEditPart getInputCompartment(ActionstepWithCompartment cep) {
//        return ((CallWSByWSDLEditPart)editPart).getOutputCompartmentPart();
//      }
//    }
//    .execute();
//  
