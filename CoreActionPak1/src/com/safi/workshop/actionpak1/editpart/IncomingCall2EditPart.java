 ...
 * @generated
 */
public class IncomingCall2EditPart extends com.safi.workshop.edit.parts.ToolstepEditPart implements ActionstepWithOutputParameters{

  /**
   * @generated
   */
  public static final int VISUAL_ID = 10003;
   ...
   * @generated
   */
  public IncomingCall2EditPart(View view) {
    super(view);
  }
...
//    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActionstepItemSemanticEditPolicy());
  ...
  public IncomingCall2 getIncomingCallModel() {
    return (IncomingCall2)getActionStep();
  }
  ...
  if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof IncomingCall2NameEditPart) {
      ((IncomingCall2NameEditPart) childEditPart).setLabel(getPrimaryShape().getToolstepNameLabel());
      return true;
    }
  ...
  protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
    ...
    if (editPart instanceof IncomingCall2NameEditPart) {
...
//  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(IncomingCall2NameEditPart.VISUAL_ID));
  }
