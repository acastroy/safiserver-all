 ...
 * @generated
 */
public class CustomInitiatorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40003;
   ...
   * @generated
   */
  public CustomInitiatorNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          ElementTypes.elementType_CustomInitiator_10002, getParserElement(), parserHint);
