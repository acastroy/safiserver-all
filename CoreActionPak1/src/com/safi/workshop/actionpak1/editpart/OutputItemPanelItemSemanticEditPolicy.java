 ...
 * @generated
 */
public class OutputItemPanelItemSemanticEditPolicy extends SafiWorkshopBaseItemSemanticEditPolicy {

  /**
   * @generated
   */
  protected Command getCreateCommand(CreateElementRequest req) {
    if (ElementTypes.elementType_OutputItem_50002 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        if (getHost().getParent() instanceof ToolstepEditPart && ((ToolstepEditPart)getHost().getParent()).getActionStep() instanceof ParameterizedActionstep)
          req.setContainmentFeature(ActionStepPackage.eINSTANCE.getParameterizedActionstep_OutputParameters());
      ...
      return getGEFWrapper(new com.safi.workshop.actionpak1.command.OutputItemCreateCommand(req));
    }
