 ...
 * @generated
 */
public class OutputItemLabelTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40007;
   ...
   * @generated
   */
  public OutputItemLabelTextEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
        EAttribute[] features = new EAttribute[] { ActionStepPackage.eINSTANCE.getInputItem_ParameterName(), };
         parser = new MessageFormatParser(features);
