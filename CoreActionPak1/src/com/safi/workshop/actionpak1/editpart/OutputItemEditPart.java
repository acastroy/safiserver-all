 ...
 * @generated
 */
public class OutputItemEditPart extends ShapeNodeEditPart implements ActionstepSubItem {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 50002;
   ...
   * @generated
   */
  public OutputItemEditPart(View view) {
    super(view);
  }
  ...
  public OutputParameter getOutputItemModel() {
    return (OutputParameter) getCaseItemModel();
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof OutputItemLabelTextEditPart) {
      ((OutputItemLabelTextEditPart) childEditPart).setLabel(getPrimaryShape()
