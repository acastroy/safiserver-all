...
public class InputItemReorderPolicy extends FlowLayoutEditPolicy {

  public InputItemReorderPolicy() {
...
//    super.decorateChild(child);
  ...
  protected Command createMoveChildCommand(final EditPart child, final EditPart after) {
    ...
    if (child instanceof InputItemEditPart && child != after
        && (after == null || after instanceof InputItemEditPart)) {
      ...
      AbstractTransactionalCommand reorderCommand = new AbstractTransactionalCommand(
        ...
        protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
          ...
          InputItem childItem = ((InputItemEditPart) child).getInputItemModel();
          
          
          EObject element = getHostObject();
          EList<InputItem> list = ((ParameterizedActionstep)element).getInputs();
