...
public class CustomInitiatorOutputsEditorPage extends AbstractActionstepEditorPage {

  private OutputItemEditorWidget outputItemEditorWidget;
  private Label outputsLabel;

  public CustomInitiatorOutputsEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    CustomInitiator customInitiator = (CustomInitiator) parent.getEditPart().getActionStep();
    ...
    IObservableList modelList = ActionstepEditObservables.observeList(editingDomain, customInitiator, customInitiator
        .eClass().getEStructuralFeature("outputParameters"));

    IObservableList uiList = new WritableList(new ArrayList<CaseItem>(customInitiator.getOutputParameters()),
