 ...
 * @generated
 */
public class ManagerActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40009;
   ...
   * @generated
   */
  public ManagerActionNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          ElementTypes.elementType_ManagerAction_10005, getParserElement(), parserHint);
