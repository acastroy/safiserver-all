 ...
 * @generated
 */
public class IncomingCall2NameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40005;
   ...
   * @generated
   */
  public IncomingCall2NameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          ElementTypes.elementType_IncomingCall2_10003, getParserElement(), parserHint);
