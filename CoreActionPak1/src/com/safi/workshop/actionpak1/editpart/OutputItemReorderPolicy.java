...
public class OutputItemReorderPolicy extends FlowLayoutEditPolicy {

  public OutputItemReorderPolicy() {
...
//          
//            list = modelElement.getInputs();
//          }
//          else
//          if (element instanceof IncomingCall2){
//            list = ((IncomingCall2)element).getInputs();
//          }
...
//            compartment.refresh();
            ((OutputItemPanelEditPart)getHost()).updateSizeIfNecessary();
            compartment.refresh();
