 ...
 * @generated
 */
public class InputItemEditPart extends ShapeNodeEditPart implements ActionstepSubItem {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 50001;
   ...
   * @generated
   */
  public InputItemEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.OPEN_ROLE, new EditInputItemPolicy());
  ...
  public InputItem getInputItemModel() {
    return (InputItem) getCaseItemModel();
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof InputItemLabelTextEditPart) {
      ((InputItemLabelTextEditPart) childEditPart).setLabel(getPrimaryShape()
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(InputItemLabelTextEditPart.VISUAL_ID));
  }
