 ...
 * @generated
 */
public class ActionstepTestNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40000;
   ...
   * @generated
   */
  public ActionstepTestNameEditPart(View view) {
    super(view);
  }
  ...
  //    if (image == null) {
  //        ImageDescriptor descriptor = AbstractUIPlugin.imageDescriptorFromPlugin("Handlers.diagram", path); //$NON-NLS-1$
  //        if (descriptor == null) {
