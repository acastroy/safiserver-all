...
public class AsteriskConfigurationDialog extends Dialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    this.hostnameField.setText(this.isNew || this.asteriskServer.getHostname() == null ? ""
    ...
    this.managerNameField.setText(this.isNew || this.asteriskServer.getManagerName() == null ? ""
        : this.asteriskServer.getManagerName());
    ...
    this.managerPassField
        .setText(this.isNew || this.asteriskServer.getManagerPassword() == null ? ""
            : this.asteriskServer.getManagerPassword());
    ...
    this.managerPortField.setText(Integer.toString(this.isNew ? 5038 : this.asteriskServer
        .getManagerPort()));
    ...
    this.descField.setText(this.isNew || this.asteriskServer.getDescription() == null ? ""
    ...
    this.sftpPassField.setText(this.isNew || this.asteriskServer.getSftpPassword() == null ? ""
        : this.asteriskServer.getSftpPassword());
    ...
    this.sftpPortField.setText(Integer
        .toString(this.isNew ? 22 : this.asteriskServer.getSftpPort()));
    ...
    synchButton.setToolTipText("Synchronize audio files with server when 'OK' is pressed");
            ...
            d.asyncExec(new Runnable() {
              public void run() {
                MessageDialog.openError(d.getActiveShell(), "Save Error",
                    "Error caught while committing resources: " + e.getLocalizedMessage());
              }
            });
          } finally {
            if (session != null) {
