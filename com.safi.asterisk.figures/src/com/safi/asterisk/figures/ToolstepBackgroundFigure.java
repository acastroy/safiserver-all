...
public class ToolstepBackgroundFigure extends ImageFigure {
  ...
  private class RenderingListenerImpl
      ...
      public void paintFigureWhileRendering(Graphics g) {
          ToolstepBackgroundFigure.this.paintFigureWhileRendering(g);
      }
      ...
      public void imageRendered(RenderedImage rndImg) {
          if (ToolstepBackgroundFigure.this.getParent() != null) {
              ToolstepBackgroundFigure.this.setRenderedImage(rndImg);
              ToolstepBackgroundFigure.this.repaint();
          }
      }
       ...
       */
      public ToolstepBackgroundFigure getFigure() {
          return ToolstepBackgroundFigure.this;
      }
       ...
       */
      public int hashCode() {
          return ToolstepBackgroundFigure.this.hashCode();
      }
   ...
   */
  public ToolstepBackgroundFigure(Image img) {
   ...
   * @param renderedImage
   */
  public ToolstepBackgroundFigure(RenderedImage renderedImage) {
   ...
   *            the image.
   */
  public ToolstepBackgroundFigure(RenderedImage renderedImage, boolean antiAlias) {
