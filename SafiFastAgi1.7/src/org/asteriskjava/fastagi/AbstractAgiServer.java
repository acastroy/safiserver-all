...
public abstract class AbstractAgiServer {
    ...
    if (pool == null) {
      ...
      pool.setRejectedExecutionHandler(new RejectedExecutionHandler() {
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
          // logger.error("No more saflet worker threads available. Rejecting job...");
          throw new RejectedExecutionException(
              "No more saflet worker threads available.  Rejecting job...");
          // System.err.println("No more saflet worker threads available. Rejecting
          // job...");
        }
      });
  ...
  protected synchronized ThreadPoolExecutor createPool() {
    return new ThreadPoolExecutor(poolSize, (maximumPoolSize < poolSize) ? poolSize
        : maximumPoolSize, 50000L, TimeUnit.MILLISECONDS, new SynchronousQueue<Runnable>(),
