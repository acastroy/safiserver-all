 ...
 * @author srt
 * @version $Id: SafiManagerConnectionFactory.java,v 1.1 2008/05/14 05:17:18 zacw Exp $
 */
public class SafiManagerConnectionFactory
{
     ...
     * @since 0.3
     */
    public SafiManagerConnectionFactory(String hostname, String username, String password)
    {
     ...
     * @since 0.3
     */
    public SafiManagerConnectionFactory(String hostname, int port, String username, String password)
    {
        this.hostname = hostname;
        this.port = port;
        this.username = username;
    ...
    {
        return new SafiManagerConnection(hostname, port, username, password);
    }
    ...
    public ManagerConnection createSecureManagerConnection()
    {
        ...
        dmc = new SafiManagerConnection(hostname, port, username, password);
        dmc.setSsl(true);
        return dmc;
    }
}
