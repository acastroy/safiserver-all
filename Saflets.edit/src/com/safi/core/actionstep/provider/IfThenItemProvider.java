...
/**
 * This is the item provider adapter for a {@link com.safi.core.actionstep.IfThen} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfThenItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_IfThen_booleanExpression_feature", "_UI_IfThen_type"),
				 ActionStepPackage.eINSTANCE.getIfThen_BooleanExpression(),
				 true,
				 false,
				 false,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActionStepPackage.eINSTANCE.getIfThen_BooleanExpression());
		}
  ...
  public String getText(Object object) {
		String label = ((IfThen)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IfThen_type") :
			getString("_UI_IfThen_type") + " " + label;
	}
