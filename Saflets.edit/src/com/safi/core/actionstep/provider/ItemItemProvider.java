...
/**
 * This is the item provider adapter for a {@link com.safi.core.actionstep.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Item_labelText_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Item_labelText_feature", "_UI_Item_type"),
         ActionStepPackage.eINSTANCE.getItem_LabelText(),
         false,
         false,
         false,
  ...
  public String getText(Object object) {
    String label = ((Item)object).getLabelText();
