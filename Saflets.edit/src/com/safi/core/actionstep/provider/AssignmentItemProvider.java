...
public class AssignmentItemProvider
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActionStepPackage.eINSTANCE.getAssignment_Value());
			childrenFeatures.add(ActionStepPackage.eINSTANCE.getAssignment_VariableName());
		}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActionStepPackage.eINSTANCE.getAssignment_Value(),
				 ActionStepFactory.eINSTANCE.createDynamicValue()));

		newChildDescriptors.add
			(createChildParameter
				(ActionStepPackage.eINSTANCE.getAssignment_VariableName(),
				 ActionStepFactory.eINSTANCE.createDynamicValue()));
	}
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ActionStepPackage.eINSTANCE.getAssignment_Value() ||
			childFeature == ActionStepPackage.eINSTANCE.getAssignment_VariableName();
