...
/**
 * This is the item provider adapter for a {@link com.safi.core.actionstep.ParameterizedActionstep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterizedActionstepItemProvider
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ParameterizedActionstepItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
		String label = ((ParameterizedActionstep)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ParameterizedActionstep_type") :
			getString("_UI_ParameterizedActionstep_type") + " " + label;
	}
  ...
  public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterizedActionstep.class)) {
