 ...
 * @generated
 */
public class SafletItemProvider
  ...
  protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Saflet_name_feature"),
				 getString("_UI_Saflet_name_description"),
				 SafletPackage.Literals.SAFLET__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Saflet_version_feature"),
				 getString("_UI_Saflet_version_description"),
				 SafletPackage.Literals.SAFLET__VERSION,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Saflet_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Saflet_description_feature", "_UI_Saflet_type"),
				 SafletPackage.Literals.SAFLET__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Saflet_type") :
			getString("_UI_Saflet_type") + " " + label;
	}
