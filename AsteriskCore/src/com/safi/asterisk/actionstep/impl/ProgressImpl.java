    ...
    if (call1 == null || call1.getChannel() == null) {
      ...
      try {
        ...
        if (debugLog.isLoggable(Level.FINEST))
          debug("Progress return value was "+translateAppReturnValue(result));
        if (result == -1){
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CallConsumer1.class) {
			switch (derivedFeatureID) {
				case ActionstepPackage.PROGRESS__CALL1: return AsteriskPackage.CALL_CONSUMER1__CALL1;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CallConsumer1.class) {
			switch (baseFeatureID) {
				case AsteriskPackage.CALL_CONSUMER1__CALL1: return ActionstepPackage.PROGRESS__CALL1;
				default: return -1;
			}
		}
