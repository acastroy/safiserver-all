  ...
  public void beginProcessing(SafletContext context) throws ActionStepException {
    ...
    if (call1 == null || call1.getChannel() == null) {
      ...
      try {
        ...
        if (StringUtils.isNotBlank(interruptKeys))
          appCmd.append(",").append(interruptKeys);
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CallConsumer1.class) {
			switch (derivedFeatureID) {
				case ActionstepPackage.FESTIVAL__CALL1: return AsteriskPackage.CALL_CONSUMER1__CALL1;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CallConsumer1.class) {
			switch (baseFeatureID) {
				case AsteriskPackage.CALL_CONSUMER1__CALL1: return ActionstepPackage.FESTIVAL__CALL1;
				default: return -1;
			}
		}
