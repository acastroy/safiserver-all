 ...
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getProductId <em>Product Id</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#isPaused <em>Paused</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#isActive <em>Active</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getSaflet <em>Saflet</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getDefaultOutput <em>Default Output</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ExecuteApplicationImpl#getErrorOutput <em>Error Output</em>}</li>
 ...
 * @generated
 */
public class ExecuteApplicationImpl extends EObjectImpl implements ExecuteApplication {
  /**
  ...
  public void setProductId(String newProductId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__PRODUCT_ID, oldProductId, productId));
  }
  ...
  public void setPaused(boolean newPaused) {
    ...
    paused = newPaused;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__PAUSED, oldPaused, paused));
  }
  ...
  public void setActive(boolean newActive) {
    ...
    active = newActive;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__ACTIVE, oldActive, active));
  }
  ...
  public EList<Output> getOutputs() {
    if (outputs == null) {
      outputs = new EObjectContainmentWithInverseEList<Output>(Output.class, this, ActionstepPackage.EXECUTE_APPLICATION__OUTPUTS, ActionStepPackage.OUTPUT__PARENT);
    }
    return outputs;
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__NAME, oldName, name));
  }
  ...
  public Saflet getSaflet() {
    if (eContainerFeatureID != ActionstepPackage.EXECUTE_APPLICATION__SAFLET) return null;
  ...
  public NotificationChain basicSetSaflet(Saflet newSaflet, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject)newSaflet, ActionstepPackage.EXECUTE_APPLICATION__SAFLET, msgs);
    return msgs;
  }
  ...
  public void setSaflet(Saflet newSaflet) {
    if (newSaflet != eInternalContainer() || (eContainerFeatureID != ActionstepPackage.EXECUTE_APPLICATION__SAFLET && newSaflet != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__SAFLET, newSaflet, newSaflet));
  }
  ...
  public Output getDefaultOutput() {
    if (defaultOutput != null && defaultOutput.eIsProxy()) {
      ...
      if (defaultOutput != oldDefaultOutput) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.EXECUTE_APPLICATION__DEFAULT_OUTPUT, oldDefaultOutput, defaultOutput));
      }
    }
  ...
  public void setDefaultOutput(Output newDefaultOutput) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__DEFAULT_OUTPUT, oldDefaultOutput, defaultOutput));
  }
  ...
  public Output getErrorOutput() {
    if (errorOutput != null && errorOutput.eIsProxy()) {
      ...
      if (errorOutput != oldErrorOutput) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.EXECUTE_APPLICATION__ERROR_OUTPUT, oldErrorOutput, errorOutput));
      }
    }
    return errorOutput;
  }
  ...
  public void setErrorOutput(Output newErrorOutput) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXECUTE_APPLICATION__ERROR_OUTPUT, oldErrorOutput, errorOutput));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case ActionstepPackage.EXECUTE_APPLICATION__OUTPUTS:
        return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutputs()).basicAdd(otherEnd, msgs);
      case ActionstepPackage.EXECUTE_APPLICATION__SAFLET:
        if (eInternalContainer() != null)
          msgs = eBasicRemoveFromContainer(msgs);
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case ActionstepPackage.EXECUTE_APPLICATION__PRODUCT_ID:
        return getProductId();
      case ActionstepPackage.EXECUTE_APPLICATION__PAUSED:
        return isPaused() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.EXECUTE_APPLICATION__ACTIVE:
        return isActive() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.EXECUTE_APPLICATION__OUTPUTS:
        return getOutputs();
      case ActionstepPackage.EXECUTE_APPLICATION__NAME:
        return getName();
      case ActionstepPackage.EXECUTE_APPLICATION__SAFLET:
        return getSaflet();
      case ActionstepPackage.EXECUTE_APPLICATION__DEFAULT_OUTPUT:
        if (resolve) return getDefaultOutput();
        return basicGetDefaultOutput();
      case ActionstepPackage.EXECUTE_APPLICATION__ERROR_OUTPUT:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == ProductIdentifiable.class) {
      switch (derivedFeatureID) {
        case ActionstepPackage.EXECUTE_APPLICATION__PRODUCT_ID: return CorePackage.PRODUCT_IDENTIFIABLE__PRODUCT_ID;
        default: return -1;
      }
    }
    if (baseClass == ActionStep.class) {
      switch (derivedFeatureID) {
        case ActionstepPackage.EXECUTE_APPLICATION__PAUSED: return ActionStepPackage.ACTION_STEP__PAUSED;
        case ActionstepPackage.EXECUTE_APPLICATION__ACTIVE: return ActionStepPackage.ACTION_STEP__ACTIVE;
        case ActionstepPackage.EXECUTE_APPLICATION__OUTPUTS: return ActionStepPackage.ACTION_STEP__OUTPUTS;
        case ActionstepPackage.EXECUTE_APPLICATION__NAME: return ActionStepPackage.ACTION_STEP__NAME;
        case ActionstepPackage.EXECUTE_APPLICATION__SAFLET: return ActionStepPackage.ACTION_STEP__SAFLET;
        case ActionstepPackage.EXECUTE_APPLICATION__DEFAULT_OUTPUT: return ActionStepPackage.ACTION_STEP__DEFAULT_OUTPUT;
        case ActionstepPackage.EXECUTE_APPLICATION__ERROR_OUTPUT: return ActionStepPackage.ACTION_STEP__ERROR_OUTPUT;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == ProductIdentifiable.class) {
      switch (baseFeatureID) {
        case CorePackage.PRODUCT_IDENTIFIABLE__PRODUCT_ID: return ActionstepPackage.EXECUTE_APPLICATION__PRODUCT_ID;
        default: return -1;
      }
    }
    if (baseClass == ActionStep.class) {
      switch (baseFeatureID) {
        case ActionStepPackage.ACTION_STEP__PAUSED: return ActionstepPackage.EXECUTE_APPLICATION__PAUSED;
        case ActionStepPackage.ACTION_STEP__ACTIVE: return ActionstepPackage.EXECUTE_APPLICATION__ACTIVE;
        case ActionStepPackage.ACTION_STEP__OUTPUTS: return ActionstepPackage.EXECUTE_APPLICATION__OUTPUTS;
        case ActionStepPackage.ACTION_STEP__NAME: return ActionstepPackage.EXECUTE_APPLICATION__NAME;
        case ActionStepPackage.ACTION_STEP__SAFLET: return ActionstepPackage.EXECUTE_APPLICATION__SAFLET;
        case ActionStepPackage.ACTION_STEP__DEFAULT_OUTPUT: return ActionstepPackage.EXECUTE_APPLICATION__DEFAULT_OUTPUT;
        case ActionStepPackage.ACTION_STEP__ERROR_OUTPUT: return ActionstepPackage.EXECUTE_APPLICATION__ERROR_OUTPUT;
        default: return -1;
      }
    }
