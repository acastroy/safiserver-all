...
public class ExtensionTransferImpl extends ActionStepImpl implements ExtensionTransfer {
		...
		try {
			...
			if (StringUtils.isBlank(ext))
				throw new ActionStepException(
				    "Extension is required for Extension Transfer ActionStep");
			...
			if (variableRawValue != null && variableRawValue instanceof ManagerConnection)
				connection = (ManagerConnection) variableRawValue;
			...
			if (isDoPreExtenStatusCheck() && connection != null) {
				...
				ExtensionStateAction action = new ExtensionStateAction(ext, ctx == null ? ""
				    : ctx);
	...
	public void setOptions(DynamicValue newOptions) {
		if (newOptions != options) {
			NotificationChain msgs = null;
			if (options != null)
				msgs = ((InternalEObject)options).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionstepPackage.EXTENSION_TRANSFER__OPTIONS, null, msgs);
			if (newOptions != null)
				msgs = ((InternalEObject)newOptions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionstepPackage.EXTENSION_TRANSFER__OPTIONS, null, msgs);
			msgs = basicSetOptions(newOptions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXTENSION_TRANSFER__OPTIONS, newOptions, newOptions));
	}
	...
	public void setDoPreExtenStatusCheck(boolean newDoPreExtenStatusCheck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.EXTENSION_TRANSFER__DO_PRE_EXTEN_STATUS_CHECK, oldDoPreExtenStatusCheck, doPreExtenStatusCheck));
	}
