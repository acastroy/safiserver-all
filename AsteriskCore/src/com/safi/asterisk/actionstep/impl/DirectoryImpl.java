 ...
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getProductId <em>Product Id</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#isPaused <em>Paused</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#isActive <em>Active</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getSaflet <em>Saflet</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getDefaultOutput <em>Default Output</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.DirectoryImpl#getErrorOutput <em>Error Output</em>}</li>
...
public class DirectoryImpl extends EObjectImpl implements Directory {
  ...
  public void setProductId(String newProductId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__PRODUCT_ID, oldProductId, productId));
  }
  ...
  public void setPaused(boolean newPaused) {
    ...
    paused = newPaused;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__PAUSED, oldPaused, paused));
  }
  ...
  public void setActive(boolean newActive) {
    ...
    active = newActive;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__ACTIVE, oldActive, active));
  }
  ...
  public EList<Output> getOutputs() {
    if (outputs == null) {
      outputs = new EObjectContainmentWithInverseEList<Output>(Output.class, this, ActionstepPackage.DIRECTORY__OUTPUTS, ActionStepPackage.OUTPUT__PARENT);
    }
    return outputs;
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__NAME, oldName, name));
  }
  ...
  public Saflet getSaflet() {
    if (eContainerFeatureID != ActionstepPackage.DIRECTORY__SAFLET) return null;
  ...
  public NotificationChain basicSetSaflet(Saflet newSaflet, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject)newSaflet, ActionstepPackage.DIRECTORY__SAFLET, msgs);
    return msgs;
  }
  ...
  public void setSaflet(Saflet newSaflet) {
    if (newSaflet != eInternalContainer() || (eContainerFeatureID != ActionstepPackage.DIRECTORY__SAFLET && newSaflet != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__SAFLET, newSaflet, newSaflet));
  }
  ...
  public Output getDefaultOutput() {
    if (defaultOutput != null && defaultOutput.eIsProxy()) {
      ...
      if (defaultOutput != oldDefaultOutput) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.DIRECTORY__DEFAULT_OUTPUT, oldDefaultOutput, defaultOutput));
      }
    }
  ...
  public void setDefaultOutput(Output newDefaultOutput) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__DEFAULT_OUTPUT, oldDefaultOutput, defaultOutput));
  }
  ...
  public Output getErrorOutput() {
    if (errorOutput != null && errorOutput.eIsProxy()) {
      ...
      if (errorOutput != oldErrorOutput) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.DIRECTORY__ERROR_OUTPUT, oldErrorOutput, errorOutput));
      }
    }
    return errorOutput;
  }
  ...
  public void setErrorOutput(Output newErrorOutput) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.DIRECTORY__ERROR_OUTPUT, oldErrorOutput, errorOutput));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case ActionstepPackage.DIRECTORY__OUTPUTS:
        return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutputs()).basicAdd(otherEnd, msgs);
      case ActionstepPackage.DIRECTORY__SAFLET:
        if (eInternalContainer() != null)
          msgs = eBasicRemoveFromContainer(msgs);
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case ActionstepPackage.DIRECTORY__PRODUCT_ID:
        return getProductId();
      case ActionstepPackage.DIRECTORY__PAUSED:
        return isPaused() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.DIRECTORY__ACTIVE:
        return isActive() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.DIRECTORY__OUTPUTS:
        return getOutputs();
      case ActionstepPackage.DIRECTORY__NAME:
        return getName();
      case ActionstepPackage.DIRECTORY__SAFLET:
        return getSaflet();
      case ActionstepPackage.DIRECTORY__DEFAULT_OUTPUT:
        if (resolve) return getDefaultOutput();
        return basicGetDefaultOutput();
      case ActionstepPackage.DIRECTORY__ERROR_OUTPUT:
      ...
      case ActionstepPackage.DIRECTORY__READ_EXTENSION_NUMBER:
        return isReadExtensionNumber() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.DIRECTORY__ENTER_BY_FIRST_NAME:
        return isEnterByFirstName() ? Boolean.TRUE : Boolean.FALSE;
      case ActionstepPackage.DIRECTORY__ENTER_BY_FIRST_OR_LAST_NAME:
        return isEnterByFirstOrLastName() ? Boolean.TRUE : Boolean.FALSE;
    }
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case ActionstepPackage.DIRECTORY__DIAL_CONTEXT:
        ...
        return;
      case ActionstepPackage.DIRECTORY__READ_EXTENSION_NUMBER:
        setReadExtensionNumber(((Boolean)newValue).booleanValue());
        return;
      case ActionstepPackage.DIRECTORY__ENTER_BY_FIRST_NAME:
        setEnterByFirstName(((Boolean)newValue).booleanValue());
        return;
      case ActionstepPackage.DIRECTORY__ENTER_BY_FIRST_OR_LAST_NAME:
        setEnterByFirstOrLastName(((Boolean)newValue).booleanValue());
        return;
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == ProductIdentifiable.class) {
      switch (derivedFeatureID) {
        case ActionstepPackage.DIRECTORY__PRODUCT_ID: return CorePackage.PRODUCT_IDENTIFIABLE__PRODUCT_ID;
        default: return -1;
      }
    }
    if (baseClass == ActionStep.class) {
      switch (derivedFeatureID) {
        case ActionstepPackage.DIRECTORY__PAUSED: return ActionStepPackage.ACTION_STEP__PAUSED;
        case ActionstepPackage.DIRECTORY__ACTIVE: return ActionStepPackage.ACTION_STEP__ACTIVE;
        case ActionstepPackage.DIRECTORY__OUTPUTS: return ActionStepPackage.ACTION_STEP__OUTPUTS;
        case ActionstepPackage.DIRECTORY__NAME: return ActionStepPackage.ACTION_STEP__NAME;
        case ActionstepPackage.DIRECTORY__SAFLET: return ActionStepPackage.ACTION_STEP__SAFLET;
        case ActionstepPackage.DIRECTORY__DEFAULT_OUTPUT: return ActionStepPackage.ACTION_STEP__DEFAULT_OUTPUT;
        case ActionstepPackage.DIRECTORY__ERROR_OUTPUT: return ActionStepPackage.ACTION_STEP__ERROR_OUTPUT;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == ProductIdentifiable.class) {
      switch (baseFeatureID) {
        case CorePackage.PRODUCT_IDENTIFIABLE__PRODUCT_ID: return ActionstepPackage.DIRECTORY__PRODUCT_ID;
        default: return -1;
      }
    }
    if (baseClass == ActionStep.class) {
      switch (baseFeatureID) {
        case ActionStepPackage.ACTION_STEP__PAUSED: return ActionstepPackage.DIRECTORY__PAUSED;
        case ActionStepPackage.ACTION_STEP__ACTIVE: return ActionstepPackage.DIRECTORY__ACTIVE;
        case ActionStepPackage.ACTION_STEP__OUTPUTS: return ActionstepPackage.DIRECTORY__OUTPUTS;
        case ActionStepPackage.ACTION_STEP__NAME: return ActionstepPackage.DIRECTORY__NAME;
        case ActionStepPackage.ACTION_STEP__SAFLET: return ActionstepPackage.DIRECTORY__SAFLET;
        case ActionStepPackage.ACTION_STEP__DEFAULT_OUTPUT: return ActionstepPackage.DIRECTORY__DEFAULT_OUTPUT;
        case ActionStepPackage.ACTION_STEP__ERROR_OUTPUT: return ActionstepPackage.DIRECTORY__ERROR_OUTPUT;
        default: return -1;
      }
    }
