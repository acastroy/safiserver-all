...
public class GetDigitsImpl extends AsteriskActionStepImpl implements GetDigits {
		...
		try {
			...
			if (v != null) {
				if (v.getScope() != VariableScope.GLOBAL)
					context.setVariableRawValue(v.getName(), VariableTranslator.translateValue(v.getType(), buf.toString()));
				else {
		...
		if (call1 != null && call1.eIsProxy()) {
			...
			if (call1 != oldCall1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.GET_DIGITS__CALL1, oldCall1,
							call1));
			}
		}
		return call1;
	...
	public void setInputTimeout(long newInputTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__INPUT_TIMEOUT,
					oldInputTimeout, inputTimeout));
	}
	...
	public void setUseBufferedDigits(boolean newUseBufferedDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__USE_BUFFERED_DIGITS,
					oldUseBufferedDigits, useBufferedDigits));
	}
	...
	public void setEscapeDigits(String newEscapeDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__ESCAPE_DIGITS,
					oldEscapeDigits, escapeDigits));
	}
	...
	public NotificationChain basicSetVariableName(DynamicValue newVariableName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ActionstepPackage.GET_DIGITS__VARIABLE_NAME, oldVariableName, newVariableName);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setVariableName(DynamicValue newVariableName) {
		if (newVariableName != variableName) {
			...
			if (variableName != null)
				msgs = ((InternalEObject) variableName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- ActionstepPackage.GET_DIGITS__VARIABLE_NAME, null, msgs);
			if (newVariableName != null)
				msgs = ((InternalEObject) newVariableName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- ActionstepPackage.GET_DIGITS__VARIABLE_NAME, null, msgs);
			msgs = basicSetVariableName(newVariableName, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__VARIABLE_NAME,
	...
	public void setMaxDigits(int newMaxDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__MAX_DIGITS, oldMaxDigits,
					maxDigits));
	}
	...
	public void setAcceptedDigits(String newAcceptedDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.GET_DIGITS__ACCEPTED_DIGITS,
					oldAcceptedDigits, acceptedDigits));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ActionstepPackage.GET_DIGITS__ACCEPTED_DIGITS:
				return ACCEPTED_DIGITS_EDEFAULT == null ? acceptedDigits != null : !ACCEPTED_DIGITS_EDEFAULT
						.equals(acceptedDigits);
		}
