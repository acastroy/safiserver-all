 ...
 * <ul>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ManagerActionImpl#getManagerActionType <em>Manager Action Type</em>}</li>
 *   <li>{@link com.safi.asterisk.actionstep.impl.ManagerActionImpl#getManagerResponse <em>Manager Response</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManagerActionImpl extends ParameterizedActionstepImpl implements ManagerAction {
	...
	protected EClass eStaticClass() {
		return ActionstepPackage.Literals.MANAGER_ACTION;
	}
	...
	public void setManagerActionType(ManagerActionType newManagerActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.MANAGER_ACTION__MANAGER_ACTION_TYPE, oldManagerActionType, managerActionType));
	}
	...
	public NotificationChain basicSetManagerResponse(DynamicValue newManagerResponse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActionstepPackage.MANAGER_ACTION__MANAGER_RESPONSE, oldManagerResponse, newManagerResponse);
	...
	public void setManagerResponse(DynamicValue newManagerResponse) {
		if (newManagerResponse != managerResponse) {
			...
			if (managerResponse != null)
				msgs = ((InternalEObject)managerResponse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionstepPackage.MANAGER_ACTION__MANAGER_RESPONSE, null, msgs);
			if (newManagerResponse != null)
				msgs = ((InternalEObject)newManagerResponse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionstepPackage.MANAGER_ACTION__MANAGER_RESPONSE, null, msgs);
			msgs = basicSetManagerResponse(newManagerResponse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.MANAGER_ACTION__MANAGER_RESPONSE, newManagerResponse, newManagerResponse));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActionstepPackage.MANAGER_ACTION__MANAGER_RESPONSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionstepPackage.MANAGER_ACTION__MANAGER_ACTION_TYPE:
