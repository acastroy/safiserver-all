...
public interface SafletPackage extends EPackage {
  ...
  /**
   * The feature id for the '<em><b>Server Ip Addr</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ASTERISK_SAFLET_ENVIRONMENT__SERVER_IP_ADDR = com.safi.core.saflet.SafletPackage.SAFLET_ENVIRONMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int ASTERISK_SAFLET_ENVIRONMENT__FAST_AGI_PORT = com.safi.core.saflet.SafletPackage.SAFLET_ENVIRONMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ASTERISK_SAFLET_ENVIRONMENT__MANAGEMENT_PORT = com.safi.core.saflet.SafletPackage.SAFLET_ENVIRONMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int ASTERISK_SAFLET_ENVIRONMENT_FEATURE_COUNT = com.safi.core.saflet.SafletPackage.SAFLET_ENVIRONMENT_FEATURE_COUNT + 3;
  ...
  /**
   * Returns the meta object for the attribute '{@link com.safi.asterisk.saflet.AsteriskSafletEnvironment#getServerIpAddr <em>Server Ip Addr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Server Ip Addr</em>'.
   * @see com.safi.asterisk.saflet.AsteriskSafletEnvironment#getServerIpAddr()
   * @see #getAsteriskSafletEnvironment()
   * @generated
   */
  EAttribute getAsteriskSafletEnvironment_ServerIpAddr();
  ...
  interface Literals {
    ...
    /**
     * The meta object literal for the '<em><b>Server Ip Addr</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute ASTERISK_SAFLET_ENVIRONMENT__SERVER_IP_ADDR = eINSTANCE.getAsteriskSafletEnvironment_ServerIpAddr();
