...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Move To Insert Row</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.safi.core.actionstep.impl.MoveToInsertRowImpl#getResultSet <em>Result Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MoveToInsertRowImpl extends ActionStepImpl implements MoveToInsertRow {
  /**
  ...
  protected EClass eStaticClass() {
    return ActionStepPackage.eINSTANCE.getMoveToInsertRow();
  }
  ...
  public void setResultSet(DBResultSetId newResultSet) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.MOVE_TO_INSERT_ROW__RESULT_SET, oldResultSet, resultSet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case ActionStepPackage.MOVE_TO_INSERT_ROW__RESULT_SET:
        return getResultSet();
    }
