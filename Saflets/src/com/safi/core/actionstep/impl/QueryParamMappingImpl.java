...
public class QueryParamMappingImpl extends ItemImpl implements QueryParamMapping {
  ...
  public void setQueryParam(DBQueryParamId newQueryParam) {
    if (newQueryParam != queryParam) {
      ...
      if (queryParam != null) {
        ...
        msgs = ((InternalEObject) queryParam).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - ActionStepPackage.QUERY_PARAM_MAPPING__QUERY_PARAM, null, msgs);
        queryParam.eAdapters().remove(adapter);
      }
      if (newQueryParam != null) {
        msgs = ((InternalEObject) newQueryParam).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - ActionStepPackage.QUERY_PARAM_MAPPING__QUERY_PARAM, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          ActionStepPackage.QUERY_PARAM_MAPPING__QUERY_PARAM, newQueryParam, newQueryParam));
  }
  ...
  public void setSetAsDatatype(SQLDataType newSetAsDatatype) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.QUERY_PARAM_MAPPING__SET_AS_DATATYPE, oldSetAsDatatype, setAsDatatype));
  }
  ...
  public void setValue(DynamicValue newValue) {
    if (newValue != value) {
      NotificationChain msgs = null;
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionStepPackage.QUERY_PARAM_MAPPING__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionStepPackage.QUERY_PARAM_MAPPING__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.QUERY_PARAM_MAPPING__VALUE, newValue, newValue));
  }
  ...
  private void updateLabelText(DBQueryParamId queryParam) {
    ...
    if (queryParam == null)
      ...
      if (StringUtils.isBlank(id))
        ...
        text = id.substring(id.lastIndexOf('.') + 1, id.length());
