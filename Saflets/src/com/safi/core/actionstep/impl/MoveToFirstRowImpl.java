...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Move To First Row</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.safi.core.actionstep.impl.MoveToFirstRowImpl#getResultSet <em>Result Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MoveToFirstRowImpl extends ActionStepImpl implements MoveToFirstRow {
  /**
  ...
  protected EClass eStaticClass() {
    return ActionStepPackage.eINSTANCE.getMoveToFirstRow();
  }
  ...
  public void setResultSet(DBResultSetId newResultSet) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.MOVE_TO_FIRST_ROW__RESULT_SET, oldResultSet, resultSet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case ActionStepPackage.MOVE_TO_FIRST_ROW__RESULT_SET:
        return getResultSet();
    }
