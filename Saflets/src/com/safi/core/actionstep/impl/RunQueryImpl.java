...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Run Query</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class RunQueryImpl extends ActionStepImpl implements RunQuery {
  ...
  public void beginProcessing(SafletContext context) throws ActionStepException {
    ...
    try {
      ...
      if (conn == null)
        throw new ActionStepException("Couldn't find DB connection with path " + connection.getId());
      ...
      if (StringUtils.isNotBlank(qry.getCatalog())) {
        if (debugLog.isDebugEnabled())
          debug("Setting default catalog of connection "+conn.getName()+" to "+qry.getCatalog());
      ...
      switch (qry.getQueryType()) {
        ...
        case SELECT: {
          if (resultSet == null) {
            throw new ActionStepException("No resultSet specified for query " + qry.getName());
          }
          jdbcStatement = jdbcConnection.prepareStatement(querySql,
          ...
          if (queryStatement instanceof CallableStatement) {
            ...
            switch (paramDatatype) {
              ...
              case INTEGER:
                ...
                break;
              case LONG:
                ps.setLong(idx, (Long) VariableTranslator.translateValue(VariableType.INTEGER,
                    result));
                break;
              case TEXT:
                ps.setString(idx, (String) VariableTranslator.translateValue(VariableType.TEXT,
                    result));
                break;
              case TIME:
      ...
      if ((qry.getQueryType() == QueryType.SELECT) || qry.getQueryType() == QueryType.SP_SELECT) {
        ResultSet rs = null;
        if (debugLog.isDebugEnabled())
  ...
  public void setConnection(DBConnectionId newConnection) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.RUN_QUERY__CONNECTION,
  ...
  public void setQuery(DBQueryId newQuery) {
    if (newQuery != query) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.RUN_QUERY__QUERY,
          newQuery, newQuery));
  }
  ...
  public void setResultSet(DBResultSetId newResultSet) {
    ...
    if (newResultSet != resultSet) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.RUN_QUERY__RESULT_SET,
  ...
  public void refreshParams(Query qry) {
    ...
    try {
      ...
      List<QueryParamMapping> mappings = new ArrayList<QueryParamMapping>(getParamMappings());
      int idx = 0;
      if (params != null && !params.isEmpty()) {
        for (QueryParameter p : params) {
          ...
          if (hasElement) {
            ...
            QueryParamMapping qpm = ActionStepFactory.eINSTANCE.createQueryParamMapping();
            qpm.setSetAsDatatype(p.getDataType());
            qpm.setQueryParam(nid);
