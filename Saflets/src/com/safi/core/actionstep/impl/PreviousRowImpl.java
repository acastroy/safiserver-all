...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Previous Row</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.safi.core.actionstep.impl.PreviousRowImpl#getResultSet <em>Result Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PreviousRowImpl extends ActionStepImpl implements PreviousRow {
  /**
  ...
  protected EClass eStaticClass() {
		return ActionStepPackage.eINSTANCE.getPreviousRow();
	}
  ...
  public void setResultSet(DBResultSetId newResultSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.PREVIOUS_ROW__RESULT_SET, oldResultSet, resultSet));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionStepPackage.PREVIOUS_ROW__RESULT_SET:
				return getResultSet();
		}
