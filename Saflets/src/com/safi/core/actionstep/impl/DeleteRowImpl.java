...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delete Row</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.safi.core.actionstep.impl.DeleteRowImpl#getResultSet <em>Result Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeleteRowImpl extends ActionStepImpl implements DeleteRow {
  /**
  ...
  protected EClass eStaticClass() {
    return ActionStepPackage.eINSTANCE.getDeleteRow();
  }
  ...
  public void setResultSet(DBResultSetId newResultSet) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.DELETE_ROW__RESULT_SET, oldResultSet, resultSet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case ActionStepPackage.DELETE_ROW__RESULT_SET:
        return getResultSet();
    }
