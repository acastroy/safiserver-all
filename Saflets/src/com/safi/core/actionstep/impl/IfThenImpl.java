...
//      if (booleanExpression!= null && booleanExpression.getType() == DynamicValueType.CUSTOM){
//        try {
//          String text = booleanExpression.getText();
//          result =  executeScript(text, getName(), context);
//        } catch (HandlerScriptException e) {
//          e.printStackTrace();
//          throw new ToolstepException("Couldn't resolve dynamicValue", e);
//        }
//      }
//      else {
//        result = resolveDynamicValue(booleanExpression, context);
//      }
