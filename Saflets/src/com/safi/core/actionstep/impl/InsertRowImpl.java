 ...
 * <ul>
 *   <li>{@link com.safi.core.actionstep.impl.InsertRowImpl#getResultSet <em>Result Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InsertRowImpl extends ActionStepImpl implements InsertRow {
  /**
  ...
  protected EClass eStaticClass() {
    return ActionStepPackage.eINSTANCE.getInsertRow();
  }
  ...
  public void setResultSet(DBResultSetId newResultSet) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActionStepPackage.INSERT_ROW__RESULT_SET, oldResultSet, resultSet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case ActionStepPackage.INSERT_ROW__RESULT_SET:
        return getResultSet();
    }
