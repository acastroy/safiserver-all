...
public class CoreSwitch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.PRODUCT_IDENTIFIABLE: {
				ProductIdentifiable productIdentifiable = (ProductIdentifiable)theEObject;
				T result = caseProductIdentifiable(productIdentifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.THREAD_SENSITIVE: {
				ThreadSensitive threadSensitive = (ThreadSensitive)theEObject;
				T result = caseThreadSensitive(threadSensitive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
