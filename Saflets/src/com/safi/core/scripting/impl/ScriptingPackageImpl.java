...
public class ScriptingPackageImpl extends EPackageImpl implements ScriptingPackage {
  ...
  public static ScriptingPackage init() {
    ...
    ScriptingPackageImpl theScriptingPackage = (ScriptingPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ScriptingPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ScriptingPackageImpl());
