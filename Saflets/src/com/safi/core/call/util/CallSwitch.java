...
public class CallSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CallPackage.SAFI_CALL: {
				SafiCall safiCall = (SafiCall)theEObject;
				T result = caseSafiCall(safiCall);
				if (result == null) result = caseThreadSensitive(safiCall);
				if (result == null) result = casePlatformDisposition(safiCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CallPackage.CALL_SOURCE1: {
				CallSource1 callSource1 = (CallSource1)theEObject;
				T result = caseCallSource1(callSource1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CallPackage.CALL_SOURCE2: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Source2</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Source2</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
