 ...
 * <li>{@link com.safi.core.saflet.impl.SafletImpl#getSafletContext <em>Saflet Context
 * </em>}</li>
 ...
 * <li>{@link com.safi.core.saflet.impl.SafletImpl#getScriptingEnvironment <em>Scripting
 * Environment</em>}</li>
 * <li>{@link com.safi.core.saflet.impl.SafletImpl#getSafletEnvironment <em>Saflet
 * Environment</em>}</li>
...
public abstract class SafletImpl extends EObjectImpl implements Saflet {
  ...
  /**
   * The cached value of the '{@link #getSafletContext() <em>Saflet Context</em>}'
  ...
  /**
   * The cached value of the '{@link #getActionsteps() <em>Actionsteps</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getScriptingEnvironment()
   * <em>Scripting Environment</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
  ...
  /**
   * The cached value of the '{@link #getSafletEnvironment() <em>Saflet Environment</em>}'
  ...
  public void setInitiator(Initiator newInitiator) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__INITIATOR,
  ...
  public void setActive(boolean newActive) {
    ...
    active = newActive;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__ACTIVE,
          oldActive, active));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__NAME, oldName,
          name));
  }
  ...
  public NotificationChain basicSetSafletContext(SafletContext newSafletContext,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SafletPackage.SAFLET__SAFLET_CONTEXT, oldSafletContext, newSafletContext);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public ScriptScope getSafletScope() {
    if (safletScope != null && safletScope.eIsProxy()) {
      InternalEObject oldSafletScope = (InternalEObject) safletScope;
      safletScope = (ScriptScope) eResolveProxy(oldSafletScope);
      if (safletScope != oldSafletScope) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              SafletPackage.SAFLET__SAFLET_SCOPE, oldSafletScope, safletScope));
      }
    }
    return safletScope;
  }
  ...
  public void setSafletScope(ScriptScope newSafletScope) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__SAFLET_SCOPE,
          oldSafletScope, safletScope));
  }
  ...
  public EList<ActionStep> getActionsteps() {
    if (actionsteps == null) {
      actionsteps = new EObjectContainmentWithInverseEList<ActionStep>(ActionStep.class, this,
          SafletPackage.SAFLET__ACTIONSTEPS, ActionStepPackage.ACTION_STEP__SAFLET);
    }
    return actionsteps;
  }
  ...
  public SafletEnvironment getSafletEnvironment() {
    if (safletEnvironment != null && safletEnvironment.eIsProxy()) {
      ...
      if (safletEnvironment != oldSafletEnvironment) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              SafletPackage.SAFLET__SAFLET_ENVIRONMENT, oldSafletEnvironment, safletEnvironment));
      }
    }
  ...
  public void setVersion(String newVersion) {
    ...
    version = newVersion;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__VERSION,
          oldVersion, version));
  }
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SafletPackage.SAFLET__DESCRIPTION,
  ...
  public SafletScript addScript(String name, String scriptText) {
    ...
    SafletScript script = scriptingEnvironment.getSafletScriptFactory().getSafletScript(name,
        scriptText);
    scriptRegistry.put(this.name + ":" + name, script);
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.ADD, SafletPackage.SAFLET__INITIATOR, null,
          script));
    return script;
  ...
  public void initializeScriptableObjects() {
    for (Variable v : safletContext.getVariables()) {
      ...
      // }
      // if (currentVal == null
      // || (currentVal instanceof UniqueTag && ((UniqueTag) currentVal).readResolve() ==
      // UniqueTag.NOT_FOUND))
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
      case SafletPackage.SAFLET__ACTIONSTEPS:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getActionsteps()).basicAdd(
            otherEnd, msgs);
    }
