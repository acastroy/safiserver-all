 ...
 * @generated
 */
public class TimeBasedRoutingNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 40001;
   ...
   * @generated
   */
  public TimeBasedRoutingNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
         ElementTypes.elementType_TimeBasedRouting_10001, getParserElement(), parserHint);
