...
public class TimeItemReorderPolicy extends FlowLayoutEditPolicy {

  public TimeItemReorderPolicy() {
...
//    super.decorateChild(child);
  ...
  protected Command createMoveChildCommand(final EditPart child, final EditPart after) {
    ...
    if (child instanceof TimeItemEditPart && child != after
        && (after == null || after instanceof TimeItemEditPart)) {

      final TimeBasedRouting choice = (TimeBasedRouting) getHostObject();
      AbstractTransactionalCommand reorderCommand = new AbstractTransactionalCommand(
        ...
        protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
          ...
          TimeItem childItem = ((TimeItemEditPart) child).getTimeItemModel();
          EList<TimeItem> list = choice.getTimes();
...
//            compartment.refresh();
            ((TimeItemPanelEditPart)getHost()).updateSizeIfNecessary();
            compartment.refresh();
