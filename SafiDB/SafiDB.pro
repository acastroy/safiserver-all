-injars 'D:\temp\safiStaging\non_obfuscated\eclipse\plugins\SafiDB_1.1.0.jar'
-outjars 'D:\temp\safiStaging\obfuscated\eclipse\plugins\SafiDB_1.1.0.jar'
...
-libraryjars 'D:\ganymede\eclipse\plugins\org.eclipse.core.runtime.compatibility_3.2.0.v20071008.jar'
...
-libraryjars 'D:\workspace\Hibernate30\c3p0-0.9.1.jar'
-libraryjars 'D:\workspace\Hibernate30\slf4j-api-1.5.2.jar'
-libraryjars 'D:\workspace\Hibernate30\slf4j-log4j12-1.5.0.jar'
-target 1.6
...
-keep class com.safi.db.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.impl.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.util.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.server.config.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.server.config.impl.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.server.config.util.* {
    public protected <fields>;
    public protected <methods>;
}

-keep class com.safi.db.manager.* {
    public protected <fields>;
    public protected <methods>;
}
