 ...
 * </copyright>
 *
 * $Id: SafiServerImpl.java,v 1.7 2008/07/15 07:04:42 zacw Exp $
 */
...
public class SafiServerImpl extends ServerResourceImpl implements SafiServer {
   ...
   * @ordered
   */
  protected static final int PORT_EDEFAULT = 4573;
  ...
  /**
   * The cached value of the '{@link #getAsteriskServers() <em>Asterisk Servers</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getAsteriskServers()
   * @generated
   * @ordered
   */
  ...
  public void setBindIP(String newBindIP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__BIND_IP, oldBindIP, bindIP));
  }
  ...
  public void setPort(int newPort) {
    ...
    port = newPort;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__PORT, oldPort, port));
  }
  ...
  public void setManagementPort(int newManagementPort) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__MANAGEMENT_PORT, oldManagementPort, managementPort));
  }
   ...
   * @generated
   */
  public EList<AsteriskServer> getAsteriskServers() {
    if (asteriskServers == null) {
      asteriskServers = new EObjectContainmentWithInverseEList<AsteriskServer>(AsteriskServer.class, this, ConfigPackage.SAFI_SERVER__ASTERISK_SERVERS, ConfigPackage.ASTERISK_SERVER__SAFI_SERVER);
    }
  ...
  public void setUser(User newUser) {
    if (newUser != user) {
      ...
      if (user != null)
        msgs = ((InternalEObject)user).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConfigPackage.SAFI_SERVER__USER, null, msgs);
      if (newUser != null)
        msgs = ((InternalEObject)newUser).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConfigPackage.SAFI_SERVER__USER, null, msgs);
      msgs = basicSetUser(newUser, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__USER, newUser, newUser));
  }
  ...
  public void setRunning(boolean newRunning) {
    ...
    running = newRunning;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__RUNNING, oldRunning, running));
  }
  ...
  public void setDebug(boolean newDebug) {
    ...
    debug = newDebug;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__DEBUG, oldDebug, debug));
  }
  ...
  public void setDbPort(int newDbPort) {
    ...
    dbPort = newDbPort;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.SAFI_SERVER__DB_PORT, oldDbPort, dbPort));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case ConfigPackage.SAFI_SERVER__ASTERISK_SERVERS:
        return ((InternalEList<InternalEObject>)(InternalEList<?>)getAsteriskServers()).basicAdd(otherEnd, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case ConfigPackage.SAFI_SERVER__MANAGEMENT_PORT:
        return new Integer(getManagementPort());
      case ConfigPackage.SAFI_SERVER__ASTERISK_SERVERS:
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case ConfigPackage.SAFI_SERVER__PORT:
        ...
        return;
      case ConfigPackage.SAFI_SERVER__MANAGEMENT_PORT:
        setManagementPort(((Integer)newValue).intValue());
        return;
      case ConfigPackage.SAFI_SERVER__ASTERISK_SERVERS:
      ...
      case ConfigPackage.SAFI_SERVER__DEBUG:
        ...
        return;
      case ConfigPackage.SAFI_SERVER__DB_PORT:
        setDbPort(((Integer)newValue).intValue());
        return;
    }
