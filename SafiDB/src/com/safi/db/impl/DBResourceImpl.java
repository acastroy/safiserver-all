 ...
 * </copyright>
 *
 * $Id: DBResourceImpl.java,v 1.3 2008/07/01 08:03:27 zacw Exp $
 */
...
public abstract class DBResourceImpl extends EObjectImpl implements DBResource {
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DbPackage.DB_RESOURCE__NAME, oldName, name));
  }
  ...
  public void setLastModified(Date newLastModified) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DbPackage.DB_RESOURCE__LAST_MODIFIED, oldLastModified, lastModified));
  }
  ...
  public void setLastUpdated(Date newLastUpdated) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DbPackage.DB_RESOURCE__LAST_UPDATED, oldLastUpdated, lastUpdated));
  }
  ...
  public void setId(int newId) {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DbPackage.DB_RESOURCE__ID, oldId, id));
  }
