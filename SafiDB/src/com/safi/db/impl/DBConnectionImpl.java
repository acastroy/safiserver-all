  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case DbPackage.DB_CONNECTION__ACQUIRE_INCREMENT:
        return new Integer(getAcquireIncrement());
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case DbPackage.DB_CONNECTION__MIN_POOL_SIZE:
        ...
        return;
      case DbPackage.DB_CONNECTION__MAX_POOL_SIZE:
        setMaxPoolSize(((Integer)newValue).intValue());
        return;
      case DbPackage.DB_CONNECTION__ACQUIRE_INCREMENT:
        setAcquireIncrement(((Integer)newValue).intValue());
        return;
      case DbPackage.DB_CONNECTION__MAX_IDLE_TIME:
        setMaxIdleTime(((Integer)newValue).intValue());
        return;
      case DbPackage.DB_CONNECTION__DRIVER:
