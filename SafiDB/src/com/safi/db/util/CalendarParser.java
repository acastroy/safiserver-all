...
public class CalendarParser
{
    ...
    public static void main(String[] args) throws CalendarParserException {
      DateFormat format = SimpleDateFormat.getDateTimeInstance();
      String dateStr = "2000-05-08 13:28:19.654";
      Calendar result = CalendarParser.parse(dateStr);
      System.err.println(dateStr+" returned "+format.format(result.getTime()));
      
      dateStr = "2000-05-08 10:28:19 pm";
      result = CalendarParser.parse(dateStr);
      System.err.println(dateStr+" returned "+format.format(result.getTime()));
      
      dateStr = "Tue Dec 02 2008 13:02:36 GMT-0800 (PST)";
      result = CalendarParser.parse(dateStr);
      System.err.println(dateStr+" returned "+format.format(result.getTime()));
    }
}
