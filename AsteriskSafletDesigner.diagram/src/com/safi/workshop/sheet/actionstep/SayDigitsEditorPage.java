...
public class SayDigitsEditorPage extends AbstractActionstepEditorPage {
  ...
  private DynamicValueEditorWidget digitsDVEWidget;

  public SayDigitsEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SayDigits saydigits = (SayDigits) parent.getEditPart().getActionStep();
    ...
    digitsLabel.setText("Digits to Say:");

    TransactionalEditingDomain editingDomain = parent.getEditPart().getEditingDomain();

    digitsDVEWidget = new DynamicValueEditorWidget(this, SWT.NONE);
    digitsDVEWidget.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
    digitsDVEWidget
        .setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(saydigits.getDigits()));
    digitsDVEWidget.setEditingDomain(editingDomain);
    digitsDVEWidget.setObject(saydigits);

    EStructuralFeature textFeature = saydigits.eClass().getEStructuralFeature("digits");
    digitsDVEWidget.setFeature(textFeature);
