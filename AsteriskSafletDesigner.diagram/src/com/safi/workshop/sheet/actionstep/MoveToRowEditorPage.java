...
public class MoveToRowEditorPage extends AbstractActionstepEditorPage {
  ...
  public MoveToRowEditorPage(ActionstepEditorDialog parent) {
    ...
    IObservableValue ob = ActionstepEditObservables.observeValue(editingDomain, moveToRow,
        moveToRow.eClass().getEStructuralFeature("name"));
    ...
    ob = ActionstepEditObservables.observeValue(editingDomain, moveToRow, moveToRow.eClass()
        .getEStructuralFeature("resultSet"));
    ...
    rowNumDVEWidget
        .setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(moveToRow.getRowNum()));
    // rowNumDVEWidget.setDynamicValue(assignmentStep.getValue());
    ...
    DynamicValueWidgetObservableValue rowNumVal = new DynamicValueWidgetObservableValue(
        rowNumDVEWidget, SWT.Modify);

    IObservableValue ob3 = ActionstepEditObservables.observeValue(editingDomain, moveToRow,
        rowNumFeature);
