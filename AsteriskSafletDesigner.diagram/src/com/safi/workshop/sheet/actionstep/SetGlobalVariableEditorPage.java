...
public class SetGlobalVariableEditorPage extends AbstractActionstepEditorPage {
  ...
  public SetGlobalVariableEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SetGlobalVariable setglobalvariable = (SetGlobalVariable) parent.getEditPart().getActionStep();
