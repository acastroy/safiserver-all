...
public class StreamAudioEditorPage extends AbstractActionstepEditorPage {
  ...
  public StreamAudioEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    StreamAudio streamaudio = (StreamAudio) parent.getEditPart().getActionStep();
    ...
    filenameDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(streamaudio
        .getFilename()));
    filenameDVEWidget.setEditingDomain(editingDomain);
    filenameDVEWidget.setObject(streamaudio);

    EStructuralFeature filenameFeature = streamaudio.eClass().getEStructuralFeature("filename");
    filenameDVEWidget.setFeature(filenameFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, streamaudio, filenameFeature);
