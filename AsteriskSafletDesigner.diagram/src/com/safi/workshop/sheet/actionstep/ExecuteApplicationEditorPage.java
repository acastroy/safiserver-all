...
public class ExecuteApplicationEditorPage extends AbstractActionstepEditorPage {
  ...
  private DynamicValueEditorWidget argsDVEWidget;

  public ExecuteApplicationEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    ExecuteApplication executeapplication = (ExecuteApplication) parent.getEditPart()
        .getActionStep();
    ...
    argsDVEWidget = new DynamicValueEditorWidget(this, SWT.NONE);
    argsDVEWidget.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
    argsDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(executeapplication
        .getArguments()));
    argsDVEWidget.setEditingDomain(editingDomain);
    argsDVEWidget.setObject(executeapplication);

    EStructuralFeature argsFeature = executeapplication.eClass().getEStructuralFeature("arguments");
    argsDVEWidget.setFeature(argsFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, executeapplication, argsFeature);
    DynamicValueWidgetObservableValue argsVal = new DynamicValueWidgetObservableValue(
        argsDVEWidget, SWT.Modify);

    bindingContext.bindValue(argsVal, ob, null, null);
