...
public class GetCallInfoInputEditorPage extends AbstractActionstepEditorPage {
  ...
  public GetCallInfoInputEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    // GetCallInfo getcallinfo = (GetCallInfo) parent.getEditPart().getActionStep();
