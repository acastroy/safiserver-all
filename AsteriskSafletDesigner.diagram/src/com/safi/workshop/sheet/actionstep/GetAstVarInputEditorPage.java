...
public class GetAstVarInputEditorPage extends AbstractActionstepEditorPage {
  ...
  public GetAstVarInputEditorPage(ActionstepEditorDialog parent) {
    super(parent);
