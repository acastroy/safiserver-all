...
public class SayPhoneticEditorPage extends AbstractActionstepEditorPage {
  ...
  public SayPhoneticEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SayPhonetic sayphonetic = (SayPhonetic) parent.getEditPart().getActionStep();
    ...
    textDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(sayphonetic.getText()));
    textDVEWidget.setEditingDomain(editingDomain);
    textDVEWidget.setObject(sayphonetic);

    EStructuralFeature textFeature = sayphonetic.eClass().getEStructuralFeature("text");
    textDVEWidget.setFeature(textFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, sayphonetic, textFeature);
