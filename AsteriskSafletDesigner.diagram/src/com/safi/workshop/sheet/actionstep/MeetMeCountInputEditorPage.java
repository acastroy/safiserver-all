...
public class MeetMeCountInputEditorPage extends AbstractActionstepEditorPage {
  ...
  private DynamicValueEditorWidget conferenceNumDVEWidget;

  public MeetMeCountInputEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    digitsLabel.setText("Conference Number:");
    ...
    conferenceNumDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(meetmecount
        .getConferenceNumber()));
    conferenceNumDVEWidget.setEditingDomain(editingDomain);
    conferenceNumDVEWidget.setObject(meetmecount);

    EStructuralFeature confNumFeature = meetmecount.eClass().getEStructuralFeature(
        "conferenceNumber");
    conferenceNumDVEWidget.setFeature(confNumFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, meetmecount, confNumFeature);
    DynamicValueWidgetObservableValue confNumVal = new DynamicValueWidgetObservableValue(
        conferenceNumDVEWidget, SWT.Modify);

    bindingContext.bindValue(confNumVal, ob, null, null);
