...
public class WaitForRingEditorPage extends AbstractActionstepEditorPage {
  ...
  public WaitForRingEditorPage(ActionstepEditorDialog parent) {
    super(parent);
