...
public class SetColValuesEditorPage extends AbstractActionstepEditorPage {
  ...
  public SetColValuesEditorPage(ActionstepEditorDialog parent) {
    ...
    IObservableValue ob = ActionstepEditObservables.observeValue(editingDomain, setColValues,
        setColValues.eClass().getEStructuralFeature("name"));
    ...
    IObservableList modelList = ActionstepEditObservables.observeList(editingDomain, setColValues,
        setColValues.eClass().getEStructuralFeature("columnMappings"));

    IObservableList uiList = new WritableList(new ArrayList<SetColMapping>(setColValues
        .getColumnMappings()), SetColMapping.class);
    ...
    ob = ActionstepEditObservables.observeValue(parent.getEditPart().getEditingDomain(),
        setColValues, setColValues.eClass().getEStructuralFeature("resultSet"));
