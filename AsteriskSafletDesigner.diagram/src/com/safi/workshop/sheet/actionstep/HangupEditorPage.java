...
public class HangupEditorPage extends AbstractActionstepEditorPage {
  ...
  public HangupEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    call1Label.setText("Call to Hangup:");
