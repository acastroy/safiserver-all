...
public class OriginateCallOutputEditorPage extends AbstractActionstepEditorPage {

  private Combo combo;
  private ComboViewer comboViewer;
  private Label call1Label;

  public OriginateCallOutputEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    IObservableValue ob = ActionstepEditObservables.observeValue(parent.getEditPart()
        ...
        .getActionStep().eClass().getEStructuralFeature("newCall1"));
