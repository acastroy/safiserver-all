...
public class ExecuteUpdateEditorPage extends AbstractActionstepEditorPage {
  ...
  public ExecuteUpdateEditorPage(ActionstepEditorDialog parent) {
    ...
    rowsUpdatedDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(executeUpdate
        .getRowsUpdatedVar()));
    ...
    EStructuralFeature rowsUpdatedFeature = executeUpdate.eClass().getEStructuralFeature(
        "rowsUpdatedVar");
    ...
    DynamicValueWidgetObservableValue varVal = new DynamicValueWidgetObservableValue(
        rowsUpdatedDVEWidget, SWT.Modify);

    IObservableValue ob2 = ActionstepEditObservables.observeValue(editingDomain, executeUpdate,
        rowsUpdatedFeature);
