...
public class AnswerEditorPage extends AbstractActionstepEditorPage {
  ...
  public AnswerEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    call1Label.setText("Call to Answer:");
