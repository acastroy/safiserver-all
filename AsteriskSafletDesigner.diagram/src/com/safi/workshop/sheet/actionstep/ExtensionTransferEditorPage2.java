...
public class ExtensionTransferEditorPage2 extends AbstractActionstepEditorPage {
  ...
  public ExtensionTransferEditorPage2(ActionstepEditorDialog parent) {
    super(parent);
    ...
    contextDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(extensiontransfer
        .getContext()));
    contextDVEWidget.setEditingDomain(editingDomain);
    contextDVEWidget.setObject(extensiontransfer);
