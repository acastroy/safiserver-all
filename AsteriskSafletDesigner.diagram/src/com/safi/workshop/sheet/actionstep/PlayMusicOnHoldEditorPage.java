...
public class PlayMusicOnHoldEditorPage extends AbstractActionstepEditorPage {
  ...
  public PlayMusicOnHoldEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    PlayMusicOnHold playmusiconhold = (PlayMusicOnHold) parent.getEditPart().getActionStep();
    ...
    holdClassDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(playmusiconhold
        .getHoldClass()));
    holdClassDVEWidget.setEditingDomain(editingDomain);
    holdClassDVEWidget.setObject(playmusiconhold);

    EStructuralFeature holdClassFeature = playmusiconhold.eClass().getEStructuralFeature(
        "holdClass");
    holdClassDVEWidget.setFeature(holdClassFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, playmusiconhold, holdClassFeature);
