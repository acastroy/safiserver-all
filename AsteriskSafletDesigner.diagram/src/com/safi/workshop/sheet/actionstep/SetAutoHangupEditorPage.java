...
public class SetAutoHangupEditorPage extends AbstractActionstepEditorPage {
  ...
  public SetAutoHangupEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    durationmsLabel.setText("Time (sec):");
    ...
    IObservableValue ob2 = ActionstepEditObservables.observeValue(parent.getEditPart()
        .getEditingDomain(), parent.getEditPart().getActionStep(), parent.getEditPart()
        .getActionStep().eClass().getEStructuralFeature("time"));
