...
public class TransferEditorPage extends AbstractActionstepEditorPage {
  ...
  public TransferEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    textDVEWidget
        .setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(transfer.getExtension()));
    textDVEWidget.setEditingDomain(editingDomain);
    textDVEWidget.setObject(transfer);

    EStructuralFeature extensionFeature = transfer.eClass().getEStructuralFeature("extension");
