...
public class SetCallerIdEditorPage extends AbstractActionstepEditorPage {
  ...
  private DynamicValueEditorWidget callerIdDVEWidget;

  public SetCallerIdEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SetCallerId setcallerid = (SetCallerId) parent.getEditPart().getActionStep();
    ...
    callerIdDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(setcallerid
        .getCallerId()));
    callerIdDVEWidget.setEditingDomain(editingDomain);
    callerIdDVEWidget.setObject(setcallerid);

    EStructuralFeature callerIdFeature = setcallerid.eClass().getEStructuralFeature("callerId");
    callerIdDVEWidget.setFeature(callerIdFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, setcallerid, callerIdFeature);
