...
public class SetPriorityEditorPage extends AbstractActionstepEditorPage {
  ...
  private DynamicValueEditorWidget priorityDVEWidget;

  public SetPriorityEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SetPriority setpriority = (SetPriority) parent.getEditPart().getActionStep();
    ...
    priorityDVEWidget = new DynamicValueEditorWidget(this, SWT.NONE);
    priorityDVEWidget.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
    priorityDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(setpriority
        .getPriority()));
    priorityDVEWidget.setEditingDomain(editingDomain);
    priorityDVEWidget.setObject(setpriority);

    EStructuralFeature priorityFeature = setpriority.eClass().getEStructuralFeature("priority");
    priorityDVEWidget.setFeature(priorityFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, setpriority, priorityFeature);
    DynamicValueWidgetObservableValue priorityVal = new DynamicValueWidgetObservableValue(
        priorityDVEWidget, SWT.Modify);

    bindingContext.bindValue(priorityVal, ob, null, null);
