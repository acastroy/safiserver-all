...
public class SetContextEditorPage extends AbstractActionstepEditorPage {
  ...
  public SetContextEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // ----------- ActionStep Stuff
    SetContext setcontext = (SetContext) parent.getEditPart().getActionStep();
    ...
    digitsLabel.setText("Dialplan Context:");
    ...
    contextDVEWidget.setDynamicValue(DynamicValueEditorUtils.copyDynamicValue(setcontext
        .getContext()));
    contextDVEWidget.setEditingDomain(editingDomain);
    contextDVEWidget.setObject(setcontext);

    EStructuralFeature contextFeature = setcontext.eClass().getEStructuralFeature("context");
    contextDVEWidget.setFeature(contextFeature);

    ob = ActionstepEditObservables.observeValue(editingDomain, setcontext, contextFeature);
