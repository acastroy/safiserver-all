...
public class GetDigitsBasicEditorPage extends AbstractActionstepEditorPage {
  ...
  public GetDigitsBasicEditorPage(ActionstepEditorDialog parent) {
    super(parent);
    ...
    // final GridData gd_acceptedDigitsText = new GridData(SWT.LEFT, SWT.CENTER, true,
    // false);
    // acceptedDigitsText.setLayoutData(gd_acceptedDigitsText);
    //  	
    ...
    ob = ActionstepEditObservables.observeValue(parent.getEditPart().getEditingDomain(), parent
        .getEditPart().getActionStep(), parent.getEditPart().getActionStep().eClass()
        .getEStructuralFeature("inputTimeout"));
    ...
    maxDigitsSpinner.setPageIncrement(1);
