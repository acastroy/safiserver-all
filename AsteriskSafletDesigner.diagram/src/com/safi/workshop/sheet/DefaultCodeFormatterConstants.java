...
public class DefaultCodeFormatterConstants {
   ...
   * @since 0.8.0
   */
  public final static String FORMATTER_COMMENT_LINE_LENGTH = JavaScriptUI.PLUGIN_ID
   ...
   * @since 0.8.0
   */
  public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES = JavaScriptUI.PLUGIN_ID
