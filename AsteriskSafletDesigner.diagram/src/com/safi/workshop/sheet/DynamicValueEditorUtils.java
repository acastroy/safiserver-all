...
public class DynamicValueEditorUtils {
  ...
  public static DynamicValueAnnotationInfo extractAnnotationInfo(final EObject obj,
    ...
    if (annotation != null) {
      ...
      if ("com.safi.workshop.sheet.assist.SafletChooserAssistant".equals(info.helperClass))
  ...
  public static DynamicValueEditor2 createDynamicValueEditor(final DynamicValueAnnotationInfo info,
      final EObject parent, final EditingDomain editingDomain, final DynamicValue dynamicValue,
