...
public class DefaultCodeFormatterOptions {
  ...
  public Map getMap() {
    ...
    options.put(DefaultCodeFormatterConstants.FORMATTER_COMMENT_LINE_LENGTH, Integer
        .toString(this.comment_line_length));
    ...
    switch (this.tab_char) {
      case SPACE:
        options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR,
            JavaScriptFormattingConstants.SPACE);
        break;
      case TAB:
        options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR,
            JavaScriptFormattingConstants.TAB);
        break;
      case MIXED:
        options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR,
