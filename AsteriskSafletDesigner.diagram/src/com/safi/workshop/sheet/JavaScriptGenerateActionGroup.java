...
public class JavaScriptGenerateActionGroup extends GenerateActionGroup {
  ...
  public JavaScriptGenerateActionGroup(ScriptEditor editor, String groupName) {
    ...
    Action action = new AddBlockCommentAction(DLTKEditorMessages.getBundleForConstructedKeys(),
    ...
    editor.markAsStateDependentAction(DLTKActionConstants.ADD_BLOCK_COMMENT, true);
    editor.markAsSelectionDependentAction(DLTKActionConstants.ADD_BLOCK_COMMENT, true);

    action = new RemoveBlockCommentAction(DLTKEditorMessages.getBundleForConstructedKeys(),
    ...
    editor.markAsStateDependentAction(DLTKActionConstants.REMOVE_BLOCK_COMMENT, true);
    editor.markAsSelectionDependentAction(DLTKActionConstants.REMOVE_BLOCK_COMMENT, true);
    ...
    action = new IndentAction(DLTKEditorMessages.getBundleForConstructedKeys(),
        "Indent.", editor, false); //$NON-NLS-1$
