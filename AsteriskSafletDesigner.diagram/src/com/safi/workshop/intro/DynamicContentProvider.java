package com.safi.workshop.intro;
...
public class DynamicContentProvider implements IIntroXHTMLContentProvider {
  ...
  private String getCurrentTimeString() {
    StringBuffer content = new StringBuffer(
        "SafiWorkshop Dynamic content from Intro ContentProvider: ");
  ...
  private String getCurrentVersion() {
    StringBuffer content = new StringBuffer("1.4.0");
    return content.toString();
  }
  ...
  public void createContent(String id, Element parent) {
    ...
    para.appendChild(dom.createTextNode(getCurrentVersion()));
