...
import com.safi.workshop.edit.policies.CaseItemItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseItemEditPart extends ShapeNodeEditPart implements ActionstepSubItem {
   ...
   * @generated
   */
  public CaseItemEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CaseItemItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.OPEN_ROLE, new EditCaseItemHandlerPolicy());
   ...
   * (non-Javadoc)
   * 
   * @see com.safi.workshop.edit.parts.ActionstepSubItem#getCaseItemModel()
   */
  // public CaseItem getCaseItemModel() {
  // Object o = basicGetModel();
  // if (o instanceof CaseItem)
  // return (CaseItem) o;
  // else
  // return (CaseItem) ((Node) o).getElement();
  // }
  public CaseItem getCaseItemModel() {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof CaseItemLabelTextEditPart) {
      ((CaseItemLabelTextEditPart) childEditPart).setLabel(getPrimaryShape()
