...
import com.safi.workshop.edit.policies.ExecuteUpdateCanonicalEditPolicy;
import com.safi.workshop.edit.policies.ExecuteUpdateItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class ExecuteUpdateEditPart extends ToolstepEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 1081;
   ...
   * @generated
   */
  public ExecuteUpdateEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExecuteUpdateItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ExecuteUpdateCanonicalEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof ExecuteUpdateNameEditPart) {
      ((ExecuteUpdateNameEditPart) childEditPart)
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(ExecuteUpdateNameEditPart.VISUAL_ID));
  }
