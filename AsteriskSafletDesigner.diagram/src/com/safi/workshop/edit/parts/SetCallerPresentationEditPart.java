...
import com.safi.workshop.edit.policies.SetCallerPresentationCanonicalEditPolicy;
import com.safi.workshop.edit.policies.SetCallerPresentationItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class SetCallerPresentationEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public SetCallerPresentationEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new SetCallerPresentationItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
        new SetCallerPresentationCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(SetCallerPresentationNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof SetCallerPresentationNameEditPart) {
      ((SetCallerPresentationNameEditPart) childEditPart).setLabel(getPrimaryShape()
