 ...
 * @generated
 */
public class StreamAudioExtendedNameEditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public StreamAudioExtendedNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.StreamAudioExtended_1034, getParserElement(), parserHint);
