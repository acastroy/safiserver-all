 ...
 * @generated
 */
public class ExtensionTransferNameEditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public ExtensionTransferNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.ExtensionTransfer_1096, getParserElement(), parserHint);
