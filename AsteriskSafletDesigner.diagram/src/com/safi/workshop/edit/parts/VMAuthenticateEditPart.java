...
import com.safi.workshop.edit.policies.VMAuthenticateCanonicalEditPolicy;
import com.safi.workshop.edit.policies.VMAuthenticateItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class VMAuthenticateEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public VMAuthenticateEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new VMAuthenticateItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new VMAuthenticateCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(VMAuthenticateNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof VMAuthenticateNameEditPart) {
      ((VMAuthenticateNameEditPart) childEditPart).setLabel(getPrimaryShape()
