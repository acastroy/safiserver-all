...
import com.safi.workshop.edit.policies.GetAvailableChannelCanonicalEditPolicy;
import com.safi.workshop.edit.policies.GetAvailableChannelItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class GetAvailableChannelEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public GetAvailableChannelEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new GetAvailableChannelItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GetAvailableChannelCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(GetAvailableChannelNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof GetAvailableChannelNameEditPart) {
      ((GetAvailableChannelNameEditPart) childEditPart).setLabel(getPrimaryShape()
