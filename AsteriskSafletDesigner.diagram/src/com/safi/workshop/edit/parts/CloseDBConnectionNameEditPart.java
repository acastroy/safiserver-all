 ...
 * @generated
 */
public class CloseDBConnectionNameEditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public CloseDBConnectionNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.CloseDBConnection_1078, getParserElement(), parserHint);
