...
public class GetColMappingReorderEditPolicy extends FlowLayoutEditPolicy {

  public GetColMappingReorderEditPolicy() {
  ...
  protected Command createMoveChildCommand(final EditPart child, final EditPart after) {
    ...
    if (child instanceof GetColMappingEditPart && child != after
        && (after == null || after instanceof GetColMappingEditPart)) {

      final GetColValues getColValues = (GetColValues) getHostObject();
      AbstractTransactionalCommand reorderCommand = new AbstractTransactionalCommand(
        ...
        protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
          ...
          GetColMapping childItem = ((GetColMappingEditPart) child).getGetColMapping();
          EList<GetColMapping> list = getColValues.getColumnMappings();
          ...
          if (displacement != 0) {
            ...
            // compartment.refresh();
            ((GetColValuesValuesPanelEditPart) getHost()).updateSizeIfNecessary();
            compartment.refresh();
