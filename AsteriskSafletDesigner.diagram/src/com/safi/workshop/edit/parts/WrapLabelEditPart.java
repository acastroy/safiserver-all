 ...
 * @generated
 */
public class WrapLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      // AsteriskElementTypes.QueryParamMapping_2006, getParserElement(), parserHint);
      ...
      parser = new IParser() {
        ...
        @Override
        public String getEditString(IAdaptable arg0, int arg1) {
          // TODO Auto-generated method stub
          return null;
        }

        @Override
        public ICommand getParseCommand(IAdaptable arg0, String arg1, int arg2) {
          // TODO Auto-generated method stub
          return null;
        }

        @Override
        public String getPrintString(IAdaptable a, int type) {

          EObject obj = (EObject) a.getAdapter(EObject.class);
          if (obj == null)
            return "-none-";
          QueryParamMapping map = (QueryParamMapping) obj;
          DBQueryParamId queryParam = map.getQueryParam();
          if (queryParam == null)
            return "-none-";
        ...
        @Override
        public boolean isAffectingEvent(Object obj, int type) {
          if (obj instanceof ENotificationImpl) {
            ENotificationImpl notify = (ENotificationImpl) obj;
            if (notify.getNotifier() instanceof QueryParamMapping)
              return true;
          }
          return false;
        }
