 ...
 * @generated
 */
public class CaseItemLabelTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public CaseItemLabelTextEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.CaseItem_2002, getParserElement(), parserHint);
