 ...
 * @generated
 */
public class AnswerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public AnswerNameEditPart(View view) {
    super(view);
  }
  ...
  // if (image == null) {
  //        ImageDescriptor descriptor = AbstractUIPlugin.imageDescriptorFromPlugin("AsteriskSafletDesigner.diagram", path); //$NON-NLS-1$
  // if (descriptor == null) {
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.Answer_1001, getParserElement(), parserHint);
