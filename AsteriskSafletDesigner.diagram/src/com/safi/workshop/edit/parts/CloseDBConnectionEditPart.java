 ...
 * @generated NOT
 */
public class CloseDBConnectionEditPart extends ToolstepEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 1078;
   ...
   * @generated
   */
  public CloseDBConnectionEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CloseDBConnectionItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CloseDBConnectionCanonicalEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof CloseDBConnectionNameEditPart) {
      ((CloseDBConnectionNameEditPart) childEditPart).setLabel(getPrimaryShape()
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(CloseDBConnectionNameEditPart.VISUAL_ID));
  }
