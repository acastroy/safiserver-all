...
import com.safi.workshop.edit.policies.ExtensionSpyCanonicalEditPolicy;
import com.safi.workshop.edit.policies.ExtensionSpyItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class ExtensionSpyEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public ExtensionSpyEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExtensionSpyItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ExtensionSpyCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(ExtensionSpyNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof ExtensionSpyNameEditPart) {
      ((ExtensionSpyNameEditPart) childEditPart).setLabel(getPrimaryShape().getToolstepNameLabel());
      return true;
    }
