...
import com.safi.workshop.edit.policies.SetGlobalVariableCanonicalEditPolicy;
import com.safi.workshop.edit.policies.SetGlobalVariableItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class SetGlobalVariableEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public SetGlobalVariableEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SetGlobalVariableItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new SetGlobalVariableCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(SetGlobalVariableNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof SetGlobalVariableNameEditPart) {
      ((SetGlobalVariableNameEditPart) childEditPart).setLabel(getPrimaryShape()
