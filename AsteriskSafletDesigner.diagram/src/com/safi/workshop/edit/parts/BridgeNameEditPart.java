 ...
 * @generated
 */
public class BridgeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public BridgeNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.Bridge_1048, getParserElement(), parserHint);
