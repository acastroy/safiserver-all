 ...
 * @generated
 */
public class StopMusicOnHoldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public StopMusicOnHoldNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.StopMusicOnHold_1020, getParserElement(), parserHint);
