 ...
 * @generated
 */
public class AssignmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.Assignment_1002, getParserElement(), parserHint);
