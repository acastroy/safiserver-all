 ...
 * @generated
 */
public class DebugLogNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public DebugLogNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.DebugLog_1056, getParserElement(), parserHint);
