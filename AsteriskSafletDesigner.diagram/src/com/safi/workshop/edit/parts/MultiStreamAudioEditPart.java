...
import com.safi.asterisk.figures.MultiStreamAudioFigure;
import com.safi.workshop.edit.policies.MultiStreamAudioCanonicalEditPolicy;
import com.safi.workshop.edit.policies.MultiStreamAudioItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class MultiStreamAudioEditPart extends ToolstepEditPart implements ActionstepWithCompartment {
   ...
   * @generated
   */
  public MultiStreamAudioEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
      ...
      public Command getCommand(Request request) {
        if (understandsRequest(request)) {
          if (request instanceof CreateViewAndElementRequest) {
            ...
            if (type == AsteriskElementTypes.AudioFileItem_2003) {
              EditPart compartmentEditPart = getChildBySemanticHint(AsteriskVisualIDRegistry
                  .getType(MultiStreamAudioFilesPanelEditPart.VISUAL_ID));
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MultiStreamAudioItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MultiStreamAudioCanonicalEditPolicy());
  ...
  // DragDropEditPolicy policy = new DragDropEditPolicy();
  // policy.
  // }
  // public EditPolicy getPrimaryDragEditPolicy() {
  ...
  protected IFigure createNodeShape() {
    return primaryShape = new MultiStreamAudioFigure();
  }
   ...
   */
  @Override
  public MultiStreamAudioFigure getPrimaryShape() {
    return (MultiStreamAudioFigure) primaryShape;
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof MultiStreamAudioNameEditPart) {
      ((MultiStreamAudioNameEditPart) childEditPart).setLabel(getPrimaryShape()
          .getFigureMultiStreamAudioNameFigure());
      return true;
    }
    if (childEditPart instanceof MultiStreamAudioFilesPanelEditPart) {
      IFigure pane = getPrimaryShape().getAudioFilesPanel();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in
      // his own way
      pane.add(((MultiStreamAudioFilesPanelEditPart) childEditPart).getFigure());
      return true;
    }
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof MultiStreamAudioFilesPanelEditPart) {
      ...
      setupContentPane(pane); // FIXME each comparment should handle his content pane in
      // his own way
      pane.remove(((MultiStreamAudioFilesPanelEditPart) childEditPart).getFigure());
      return true;
    }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(MultiStreamAudioNameEditPart.VISUAL_ID));
  }
