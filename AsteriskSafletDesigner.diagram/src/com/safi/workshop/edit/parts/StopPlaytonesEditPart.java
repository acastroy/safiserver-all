...
import com.safi.workshop.edit.policies.StopPlaytonesCanonicalEditPolicy;
import com.safi.workshop.edit.policies.StopPlaytonesItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class StopPlaytonesEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public StopPlaytonesEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StopPlaytonesItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StopPlaytonesCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(StopPlaytonesNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof StopPlaytonesNameEditPart) {
      ((StopPlaytonesNameEditPart) childEditPart)
