...
import com.safi.workshop.edit.policies.OpenQueryParamEditPolicy;
import com.safi.workshop.edit.policies.SetQueryParamCanonicalEditPolicy;
import com.safi.workshop.edit.policies.SetQueryParamItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class SetQueryParamEditPart extends ToolstepEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 1080;
   ...
   * @generated
   */
  public SetQueryParamEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SetQueryParamItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new SetQueryParamCanonicalEditPolicy());
    installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
    installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenQueryParamEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof SetQueryParamNameEditPart) {
      ((SetQueryParamNameEditPart) childEditPart)
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(SetQueryParamNameEditPart.VISUAL_ID));
  }
