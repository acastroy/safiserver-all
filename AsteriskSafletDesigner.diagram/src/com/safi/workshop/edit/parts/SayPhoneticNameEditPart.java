 ...
 * @generated
 */
public class SayPhoneticNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public SayPhoneticNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.SayPhonetic_1013, getParserElement(), parserHint);
