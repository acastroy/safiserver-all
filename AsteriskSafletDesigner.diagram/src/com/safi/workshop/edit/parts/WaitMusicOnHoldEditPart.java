...
import com.safi.workshop.edit.policies.WaitMusicOnHoldCanonicalEditPolicy;
import com.safi.workshop.edit.policies.WaitMusicOnHoldItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class WaitMusicOnHoldEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public WaitMusicOnHoldEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WaitMusicOnHoldItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new WaitMusicOnHoldCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(WaitMusicOnHoldNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof WaitMusicOnHoldNameEditPart) {
      ((WaitMusicOnHoldNameEditPart) childEditPart).setLabel(getPrimaryShape()
