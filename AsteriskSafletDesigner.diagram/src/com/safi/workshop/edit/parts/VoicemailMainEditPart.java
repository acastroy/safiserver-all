...
import com.safi.workshop.edit.policies.VoicemailMainCanonicalEditPolicy;
import com.safi.workshop.edit.policies.VoicemailMainItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class VoicemailMainEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public VoicemailMainEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new VoicemailMainItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new VoicemailMainCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(VoicemailMainNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof VoicemailMainNameEditPart) {
      ((VoicemailMainNameEditPart) childEditPart)
