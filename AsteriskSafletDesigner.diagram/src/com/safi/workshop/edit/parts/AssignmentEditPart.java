...
import com.safi.asterisk.figures.AssignmentFigure;
import com.safi.workshop.edit.policies.AssignmentCanonicalEditPolicy;
import com.safi.workshop.edit.policies.AssignmentItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class AssignmentEditPart extends ToolstepEditPart {
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new AssignmentCanonicalEditPolicy());
  ...
  protected IFigure createNodeShape() {
    return primaryShape = new AssignmentFigure();
  }
   ...
   */
  @Override
  public AssignmentFigure getPrimaryShape() {
    return (AssignmentFigure) primaryShape;
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof AssignmentNameEditPart) {
      ((AssignmentNameEditPart) childEditPart).setLabel(getPrimaryShape()
          .getFigureAssignmentNameFigure());
      return true;
    }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(AssignmentNameEditPart.VISUAL_ID));
  }
