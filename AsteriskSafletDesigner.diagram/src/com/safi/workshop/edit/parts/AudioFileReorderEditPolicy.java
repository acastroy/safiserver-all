...
public class AudioFileReorderEditPolicy extends FlowLayoutEditPolicy {

  public AudioFileReorderEditPolicy() {
  ...
  protected Command createMoveChildCommand(final EditPart child, final EditPart after) {
    ...
    if (child instanceof AudioFileItemEditPart && child != after
        && (after == null || after instanceof AudioFileItemEditPart)) {

      final MultiStreamAudio multiStreamAudio = (MultiStreamAudio) getHostObject();
      AbstractTransactionalCommand reorderCommand = new AbstractTransactionalCommand(
        ...
        protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
          ...
          AudioFileItem childItem = ((AudioFileItemEditPart) child).getAudioFileItem();
          EList<AudioFileItem> list = multiStreamAudio.getAudioFilenames();
