 ...
 * @generated
 */
public class WaitMusicOnHoldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public WaitMusicOnHoldNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.WaitMusicOnHold_1058, getParserElement(), parserHint);
