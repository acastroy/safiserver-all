 ...
 * @generated NOT
 */
public class SetColValuesEditPart extends ToolstepEditPart implements ActionstepWithCompartment {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 1095;
   ...
   * @generated
   */
  public SetColValuesEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
      ...
      public Command getCommand(Request request) {
        if (understandsRequest(request)) {
          if (request instanceof CreateViewAndElementRequest) {
            ...
            if (type == AsteriskElementTypes.SetColMapping_2005) {
              EditPart compartmentEditPart = getChildBySemanticHint(AsteriskVisualIDRegistry
                  .getType(SetColValuesValuesPanelEditPart.VISUAL_ID));
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SetColValuesItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new SetColValuesCanonicalEditPolicy());
  ...
  protected IFigure createNodeShape() {
    return primaryShape = new SetColValuesFigure();
  }
   ...
   */
  @Override
  public SetColValuesFigure getPrimaryShape() {
    return (SetColValuesFigure) primaryShape;
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof SetColValuesValuesPanelEditPart) {
      IFigure pane = getPrimaryShape().getValuesPanel();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in
      // his own way
      pane.add(((SetColValuesValuesPanelEditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof SetColValuesNameEditPart) {
      ((SetColValuesNameEditPart) childEditPart).setLabel(getPrimaryShape()
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof SetColValuesValuesPanelEditPart) {
      ...
      setupContentPane(pane); // FIXME each comparment should handle his content pane in
      // his own way
      pane.remove(((SetColValuesValuesPanelEditPart) childEditPart).getFigure());
      return true;
    }
  ...
  protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
    ...
    if (editPart instanceof SetColValuesValuesPanelEditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(SetColValuesNameEditPart.VISUAL_ID));
  }
