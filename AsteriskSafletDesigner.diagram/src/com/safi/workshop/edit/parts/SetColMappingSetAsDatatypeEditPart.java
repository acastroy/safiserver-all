 ...
 * @generated
 */
public class SetColMappingSetAsDatatypeEditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public SetColMappingSetAsDatatypeEditPart(View view) {
    super(view);
  }
  ...
  protected String getLabelText() {
    ...
    SetColMapping mapping = (SetColMapping) parserElement;
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.SetColMapping_2005, getParserElement(), parserHint);
