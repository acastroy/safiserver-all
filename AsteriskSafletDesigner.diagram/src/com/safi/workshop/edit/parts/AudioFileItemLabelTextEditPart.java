 ...
 * @generated
 */
public class AudioFileItemLabelTextEditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public AudioFileItemLabelTextEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.AudioFileItem_2003, getParserElement(), parserHint);
