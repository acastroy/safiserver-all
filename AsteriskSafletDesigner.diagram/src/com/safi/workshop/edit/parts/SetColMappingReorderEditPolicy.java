...
public class SetColMappingReorderEditPolicy extends FlowLayoutEditPolicy {

  public SetColMappingReorderEditPolicy() {
  ...
  protected Command createMoveChildCommand(final EditPart child, final EditPart after) {
    ...
    if (child instanceof SetColMappingEditPart && child != after
        && (after == null || after instanceof SetColMappingEditPart)) {

      final SetColValues setColValues = (SetColValues) getHostObject();
      AbstractTransactionalCommand reorderCommand = new AbstractTransactionalCommand(
        ...
        protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
          ...
          SetColMapping childItem = ((SetColMappingEditPart) child).getSetColMapping();
          EList<SetColMapping> list = setColValues.getColumnMappings();
          ...
          if (displacement != 0) {
            ...
            // compartment.refresh();
            ((SetColValuesValuesPanelEditPart) getHost()).updateSizeIfNecessary();
            compartment.refresh();
