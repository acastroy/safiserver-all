 ...
 * @generated
 */
public class PlayMusicOnHoldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public PlayMusicOnHoldNameEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new AsteriskParserProvider.HintAdapter(
          AsteriskElementTypes.PlayMusicOnHold_1031, getParserElement(), parserHint);
