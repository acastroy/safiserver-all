 ...
 * @generated NOT
 */
public class StopMusicOnHoldEditPart extends ToolstepEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 1020;
   ...
   * @generated
   */
  public StopMusicOnHoldEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StopMusicOnHoldItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StopMusicOnHoldCanonicalEditPolicy());
  ...
  protected IFigure createNodeShape() {
    return primaryShape = new StopMusicOnHoldFigure();
  }
   ...
   */
  @Override
  public StopMusicOnHoldFigure getPrimaryShape() {
    return (StopMusicOnHoldFigure) primaryShape;
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof StopMusicOnHoldNameEditPart) {
      ((StopMusicOnHoldNameEditPart) childEditPart).setLabel(getPrimaryShape()
          .getFigureStopMusicOnHoldNameFigure());
      return true;
    }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(StopMusicOnHoldNameEditPart.VISUAL_ID));
  }
