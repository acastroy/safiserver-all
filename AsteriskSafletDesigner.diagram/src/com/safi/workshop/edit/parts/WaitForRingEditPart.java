...
import com.safi.workshop.edit.policies.WaitForRingCanonicalEditPolicy;
import com.safi.workshop.edit.policies.WaitForRingItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class WaitForRingEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public WaitForRingEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WaitForRingItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new WaitForRingCanonicalEditPolicy());
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(WaitForRingNameEditPart.VISUAL_ID));
  }
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof WaitForRingNameEditPart) {
      ((WaitForRingNameEditPart) childEditPart).setLabel(getPrimaryShape().getToolstepNameLabel());
      return true;
    }
