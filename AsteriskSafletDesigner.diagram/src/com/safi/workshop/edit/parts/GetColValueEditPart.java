...
import com.safi.workshop.edit.policies.GetColValueCanonicalEditPolicy;
import com.safi.workshop.edit.policies.GetColValueItemSemanticEditPolicy;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated NOT
 */
public class GetColValueEditPart extends ToolstepEditPart {
   ...
   * @generated
   */
  public GetColValueEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GetColValueItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GetColValueCanonicalEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (super.addFixedChild(childEditPart))
      return true;
    if (childEditPart instanceof GetColValueNameEditPart) {
      ((GetColValueNameEditPart) childEditPart).setLabel(getPrimaryShape().getToolstepNameLabel());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(AsteriskVisualIDRegistry
        .getType(GetColValueNameEditPart.VISUAL_ID));
  }
