...
public class OpenQueryParamEditPolicy extends OpenEditPolicy {
  ...
  protected Command getOpenCommand(Request request) {
    ...
    final SetQueryParam openQuery = (SetQueryParam) ((SetQueryParamEditPart) target)
        .getActionStep();
  ...
  class OpenQueryParamCommand extends AbstractTransactionalCommand {
    ...
    public OpenQueryParamCommand(GraphicalEditPart editPart, DBQueryParamId id,
        SetQueryParam openQuery) {
