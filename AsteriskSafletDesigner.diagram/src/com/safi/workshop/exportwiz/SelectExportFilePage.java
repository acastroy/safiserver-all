...
public class SelectExportFilePage extends WizardPage {
  ...
  public SelectExportFilePage() {
    super("wizardPage");
    setTitle("Export SAR (Safi Archive File)");
    setDescription("Enter the location and name of the SAR export file you wish to create");
  }
  ...
  public void createControl(Composite parent) {
    ...
    browseButton.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(final SelectionEvent e) {
        ...
        dlg.setText("To where to you want to save the Safi Archive file?");
