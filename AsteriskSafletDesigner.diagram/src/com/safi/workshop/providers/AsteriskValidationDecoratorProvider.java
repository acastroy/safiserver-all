...
import com.safi.workshop.part.ValidationMarker;

/**
 * @generated
 */
public class AsteriskValidationDecoratorProvider extends AbstractProvider implements
    IDecoratorProvider {
  ...
  public void createDecorators(IDecoratorTarget decoratorTarget) {
    ...
    if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
      ...
      if (((DiagramEditDomain) ed).getEditorPart() instanceof AsteriskDiagramEditor) {
  ...
  public boolean provides(IOperation operation) {
    ...
    return view != null
        && HandlerEditPart.MODEL_ID.equals(AsteriskVisualIDRegistry.getModelID(view));
  }
    ...
    PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
      ...
      public void run() {
        try {
          ...
          AsteriskDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
        }
      }
    });
  }
  ...
  public static class StatusDecorator extends AbstractDecorator {
    ...
    public StatusDecorator(IDecoratorTarget decoratorTarget) {
      ...
      try {
        ...
        AsteriskDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
      }
    }
    ...
    public void refresh() {
      ...
      Label toolTip = null;
      for (ValidationMarker marker : markers) {
