...
public abstract class WorkbenchAdvisorHack extends WorkbenchAdvisor {
   ...
   * in {@link IDE.SharedImages}) and internal images (named in
   ...
   * @param path
   *          the path of the image file; this path is relative to the base of the IDE
   *          plug-in
   * @param shared
   *          <code>true</code> if this is a shared image, and <code>false</code> if this
