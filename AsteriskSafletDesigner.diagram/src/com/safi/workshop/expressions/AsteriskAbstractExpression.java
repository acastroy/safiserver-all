package com.safi.workshop.expressions;
 ...
 * @generated
 */
public abstract class AsteriskAbstractExpression {
  /**
   * @generated
   */
  private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean.valueOf(
      Platform.getDebugOption(AsteriskDiagramEditorPlugin.getInstance().getBundle()
          .getSymbolicName()
   ...
   * @generated
   */
  protected AsteriskAbstractExpression(EClassifier context) {
    this(null, context);
  }
   ...
   * @generated
   */
  protected AsteriskAbstractExpression(String body, EClassifier context) {
    this.body = body;
  ...
  protected void setStatus(int severity, String message, Throwable throwable) {
    String pluginID = AsteriskDiagramEditorPlugin.ID;
   ...
   * @generated
   */
  public static final AsteriskAbstractExpression createNullExpression(EClassifier context) {
    return new AsteriskAbstractExpression(context) {
