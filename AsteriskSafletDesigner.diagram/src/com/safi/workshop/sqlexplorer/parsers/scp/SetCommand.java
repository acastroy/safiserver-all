...
/*package*/class SetCommand extends Command {
  ...
  public SetCommand(StructuredCommentParser parser, Token comment, Tokenizer tokenizer,
    ...
    if (tokens.size() != 1)
      throw new StructuredCommentException(commandType + " has extra text after option name",
          comment);
