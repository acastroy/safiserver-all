...
/*package*/class ParameterCommand extends Command {
  ...
  public ParameterCommand(StructuredCommentParser parser, Token comment, Tokenizer tokenizer,
    ...
    parser.parser.addParameter(new NamedParameter(comment, name, dataType, direction, arguments,
        data));
  }
  ...
  protected String popWord() throws StructuredCommentException {
    ...
    if (token.getTokenType() != TokenType.WORD)
      throw new StructuredCommentException("Invalid token, expected a word but got "
