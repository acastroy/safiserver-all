...
/**
 * The QueryParser produces a series of Query objects; they are expected to be fairly
 * light-weight and to use the CharSequence to point into the original buffer rather than
