...
public class NamedParameter implements Comparable<NamedParameter> {
  ...
  public enum DataType {
    INTEGER {
      @Override
      public void configureStatement(NamedParameter param, CallableStatement stmt, int columnIndex)
          throws SQLException {
        if (param.isOutput())
    ...
    public abstract void configureStatement(NamedParameter param, CallableStatement stmt,
  ...
  public NamedParameter(Token comment, String name, DataType dataType, Direction direction,
      List<Token> arguments, CharSequence value) {
    super();
  ...
  /**
   * Configures the statement with this parameter, where the parameter is at a given
   * ordinal index
   * 
   * @param stmt
   * @param param
  ...
  public String toString() {
    return ":" + name + "[" + direction.toString().toLowerCase() + " "
