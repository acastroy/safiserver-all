...
/**
 * Implementation of Query that provides for more a sophisticated description of the task
 * to be performed, namely: defining parameters, interactive questions which need to be
 * asked, and content-type overrides.
 * 
...
public class AnnotatedQuery extends AbstractQuery {
   ...
   * (non-Javadoc)
   * 
   * @see com.safi.workshop.sqlexplorer.parsers.Query#getQueryType()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.safi.workshop.sqlexplorer.parsers.Query#getQuerySql()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.safi.workshop.sqlexplorer.parsers.Query#getLineNo()
   */
