...
/**
 * Factory class used to create instances of Previewer for a given MIME content type or
...
public final class PreviewerFactory {
  ...
  public interface Resolver {
    ...
    /**
     * Called to discover whether a given Object can be handled; this should not include
     * implicit conversions to String etc
     * 
     * @param data
     * @return
     */
  ...
  /**
   * Returns a Previewer-derived instance based solely on the type of object in <data/>
   * 
   * @param mimeType
   *          the MIME content type
   * @param data
