...
public class XmlPreviewer implements Previewer {
    ...
    tree.setLabelProvider(new LabelProvider() {
      ...
      public String getText(Object obj) {
        ...
        for (Object o : elem.attributes()) {
          ...
          result.append(' ').append(attr.getName()).append('=').append('\"')
  ...
  public static void register() {
    PreviewerFactory.getInstance().registerClass(new PreviewerFactory.Resolver() {
       ...
       * 
       * @see
       * com.safi.workshop.sqlexplorer.preview.PreviewerFactory.Resolver#canAcceptMimeType
       * (java.lang.String)
       */
       ...
       * 
       * @see
       * com.safi.workshop.sqlexplorer.preview.PreviewerFactory.Resolver#canAcceptObject
       * (java.lang.Object)
       */
       ...
       * 
       * @see
       * com.safi.workshop.sqlexplorer.preview.PreviewerFactory.Resolver#getPreviewerClass
       * ()
       */
