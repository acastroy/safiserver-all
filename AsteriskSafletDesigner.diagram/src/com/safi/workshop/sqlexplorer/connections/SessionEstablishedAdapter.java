...
public class SessionEstablishedAdapter implements SessionEstablishedListener {
   ...
   * (non-Javadoc)
   * 
   * @seecom.safi.workshop.sqlexplorer.connections.SessionEstablishedListener#
   * cannotEstablishSession(com.safi.workshop.sqlexplorer.dbproduct.User)
   */
   ...
   * 
   * @see
   * com.safi.workshop.sqlexplorer.connections.SessionEstablishedListener#sessionEstablished
   * (com.safi.workshop.sqlexplorer.dbproduct.Session)
   */
