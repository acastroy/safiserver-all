...
public class SQLExplorerPluginPerspective implements IPerspectiveFactory {
  ...
  /**
   * Creates the default initial layout for this plugin. This method fufills the contract
   * for the IPerspectiveFactory interface
   * 
   * @param IPageLayout
   */
  ...
  private void defineLayout(IPageLayout layout) {
    ...
    IFolderLayout bottomLeft = layout.createFolder("bottomLeft", IPageLayout.BOTTOM, 0.3f,
        "topLeft");
    ...
    IFolderLayout bottomRight = layout.createFolder("bottomRight", IPageLayout.BOTTOM, 0.90f,
        "right");
