...
public class Message {
   ...
   * 
   * @param status
   *          true if the message is about status
   * @param lineNo
   *          first line number in sql that the message relates to
   * @param charNo
   *          first character within the line identified by lineNo that the message
   *          relates to
   * @param sql
   *          the SQL or command that was executed
   * @param message
   *          the message
   */
   ...
   * 
   * @param status
   *          true if the message is about success
   * @param lineNo
   *          first line number in sql that the message relates to
   * @param charNo
   *          first character within the line identified by lineNo that the message
  ...
  /* package */String[] getTableText() {
    ...
    String[] result = new String[] { status.getText(), location, (sql == null) ? "" : sql,
  ...
  /**
   * The first line within getSql() to which the message relates; zero if not available
   * 
   * @return the lineNo
   */
  ...
  /**
   * The first character offset within the line identified by getLineNo() to which the
   * message relates. Zero if not available
   * 
   * @return the charNo
   */
