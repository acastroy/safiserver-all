...
class MouseClickListener implements KeyListener, MouseListener, MouseMoveListener, FocusListener,
   ...
   * 
   * @see
   * org.eclipse.jface.text.IDocumentListener#documentAboutToBeChanged(org.eclipse.jface
   * .text.DocumentEvent)
   */
   ...
   * (non-Javadoc)
   * 
   * @seeorg.eclipse.jface.text.IDocumentListener#documentChanged(org.eclipse.jface.text.
   * DocumentEvent)
   */
   ...
   * 
   * @see
   * org.eclipse.jface.text.ITextInputListener#inputDocumentAboutToBeChanged(org.eclipse
   ...
   * 
   * @see
   * org.eclipse.jface.text.ITextInputListener#inputDocumentChanged(org.eclipse.jface.
        ...
        public void run() {
          ...
          try {
            ...
            if (structureView != null) {
              editor.getEditorSite().getWorkbenchWindow().getActivePage().bringToTop(structureView);
            }
