...
import com.safi.workshop.sqlexplorer.preview.Previewer;
import com.safi.workshop.sqlexplorer.preview.PreviewerFactory;

/**
 * The DataPreview provides a read-only view of data which would not otherwise fit
 * comfortably in the results tabs, e.g. an XML tree or an image.
 * 
 * It has fairly limited functionality, it's task is to manipulate instances of classes
 * which implement com.safi.workshop.sqlexplorer.preview.Previewer.
 * 
 * @see com.safi.workshop.sqlexplorer.preview.Previewer
 * @see com.safi.workshop.sqlexplorer.preview.PreviewerFactory
