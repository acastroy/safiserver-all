...
/**
 * Constants that define all the available views in this plugin, and what we want the
 * default views to be. Each view constant is the string ID provided in the plugin.xml
 * file.
 * 
 * @author Macon Pegram
 */
public final class SqlexplorerViewConstants {
  ...
  public static final String SQLEXPLORER_CONNECTIONS = "com.safi.eclipse.NavigatorView";// ConnectionsView.class.getName();
  ...
  public final static String PATT_PARAM = ":[a-zA-Z_][a-zA-z_0-9]+";
  ...
  /**
   * Returns the list of default view Ids which we want to see by default when a
   * perspective is opened for the first time.
   * 
   * @return List
   */
