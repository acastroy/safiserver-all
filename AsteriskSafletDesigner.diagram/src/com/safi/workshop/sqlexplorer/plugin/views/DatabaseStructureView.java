...
import com.safi.workshop.sqlexplorer.dbstructure.DBTreeActionGroup;
import com.safi.workshop.sqlexplorer.dbstructure.DBTreeContentProvider;
import com.safi.workshop.sqlexplorer.dbstructure.DBTreeLabelProvider;
import com.safi.workshop.sqlexplorer.dbstructure.actions.FilterStructureAction;
...
/**
 * Database Structure View. Shows the database outline. Selections made in this view are
 * shown in the DatabaseDetailView.
 * 
...
public class DatabaseStructureView extends ViewPart {
  ...
  private void addSession(final MetaDataSession session) throws SQLCannotConnectException {
    ...
    if (_tabFolder == null || _tabFolder.isDisposed()) {
      ...
      _tabFolder.setSelectionBackground(new Color[] { display.getSystemColor(SWT.COLOR_WHITE),
          new Color(null, 211, 225, 250), new Color(null, 175, 201, 246),
    ...
    // create outline
    final TreeViewer treeViewer = new TreeViewer(composite, SWT.V_SCROLL | SWT.H_SCROLL | SWT.MULTI
        | SWT.BORDER);
  ...
  public void refreshSessionTrees(Session session) {
    if (SQLExplorerPlugin.getDefault() != null
        && SQLExplorerPlugin.getDefault().getDatabaseStructureView() != this)
      SQLExplorerPlugin.getDefault().setDatabaseStructureView(this);
    if (_tabFolder == null || _tabFolder.getSelectionIndex() < 0)
      return;
  ...
  /**
   * Set a default message, this method is called when no sessions are available for
   * viewing.
   */
    ...
    BusyIndicator.showWhile(Display.getCurrent(), new Runnable() {
      ...
      public void run() {
        ...
        if (_tabFolder == null || _tabFolder.getItemCount() == 0
            || _tabFolder.getSelectionIndex() < 0) {
          return;
        }
