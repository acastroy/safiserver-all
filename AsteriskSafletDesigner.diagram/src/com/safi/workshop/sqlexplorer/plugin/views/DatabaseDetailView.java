...
/**
 * Database Detail View. Provides a detailed view on the selection in the database
 * structure view.
 * 
...
public class DatabaseDetailView extends ViewPart {
  ...
  /**
   * Create our detail view. If the detail view is recreated after the structure view was
   * already available, the currently selected node in the structure view will be
   * displayed.
   * 
  ...
  public void createPartControl(Composite parent) {
    ...
    PlatformUI.getWorkbench().getHelpSystem().setHelp(parent,
        SQLExplorerPlugin.PLUGIN_ID + ".DatabaseDetailView");
    ...
    if (SQLExplorerPlugin.getDefault() != null) {
      ...
      DatabaseStructureView structureView = SQLExplorerPlugin.getDefault()
  ...
  /**
   * Show the details for the given node. If node is null, a default message will be
   * displayed.
   * 
   * @param node
   *          INode.
