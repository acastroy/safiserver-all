 ...
 */
package com.safi.workshop.sqlexplorer.plugin.views;
...
import com.safi.workshop.sqlexplorer.history.SQLHistoryChangedListener;
import com.safi.workshop.sqlexplorer.history.SQLHistoryElement;
import com.safi.workshop.sqlexplorer.history.SQLHistoryLabelProvider;
import com.safi.workshop.sqlexplorer.history.SQLHistorySearchListener;
import com.safi.workshop.sqlexplorer.history.actions.AddDBQueryAction;
import com.safi.workshop.sqlexplorer.history.actions.RemoveFromHistoryAction;
import com.safi.workshop.sqlexplorer.history.actions.SQLHistoryActionGroup;
import com.safi.workshop.sqlexplorer.plugin.SQLExplorerPlugin;
import com.safi.workshop.sqlexplorer.util.TextUtil;

/**
 * SQL History view shows all succesfully executed sql statements. The list of statements
 * remains persistent between sessions.
 * 
...
public class SQLHistoryView extends ViewPart implements SQLHistoryChangedListener {
   ...
   * (non-Javadoc)
   * 
   * @see com.safi.workshop.sqlexplorer.plugin.SqlHistoryChangedListener#changed()
   */
  public void changed() {
  ...
  public void createPartControl(final Composite parent) {
    ...
    PlatformUI.getWorkbench().getHelpSystem().setHelp(parent,
        SQLExplorerPlugin.PLUGIN_ID + ".SQLHistoryView");
    ...
    _tableViewer = new TableViewer(composite, SWT.V_SCROLL | SWT.H_SCROLL | SWT.FULL_SELECTION
    ...
    final SQLHistoryActionGroup actionGroup = new SQLHistoryActionGroup(this, history,
        _tableViewer, toolBarMgr);
  ...
  private void setHoverLocation(Shell shell, Point position, int labelHeight) {
    ...
    shellBounds.y = Math.max(Math.min(position.y + 10, displayBounds.height - shellBounds.height),
        0);
