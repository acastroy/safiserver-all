...
/**
 * QueryTokenizer based on original SquirreL SQL tokenizer, but adds the possibility to
 * use multiple characters as the sql delimeter.
 * 
 * This is used for splitting the input text in the editor into multiple executable sql
 * statements.
 * 
...
public class QueryTokenizer {
  ...
  /**
   * These characters at the beginning of an SQL statement indicate that it is a comment.
   */
   ...
   */
  public QueryTokenizer(String sql, String querySeparator, String alternateSeparator,
      String solComment) {
