...
public class ImageUtil {
  ...
  /**
   * Dispose of an image in cache. Once there are no more open handles to the image it
   * will be disposed of.
   * 
   */
  ...
  /**
   * Get an image object from cache or create one if it doesn't exist yet. Everytime an
   * object is retrieved, it should be disposed of using the ImageUtil.disposeImage
   * method.
   * 
   * @param propertyName
   */
