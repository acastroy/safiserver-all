...
public class TextUtil {
  ...
  /**
   * Trims whitespace from a string and compresses all internal whitespace down to a
   * single space.
   * 
   * @param source
  ...
  /**
   * Trims whitespace from a string and compresses all internal whitespace down to a
   * single space. Keeps the length of the string to at most maxLength, but if it
   * truncates then it makes the last 3 characters an elipsis
   * 
   * @param source
   *          the string to compress
   * @param maxLength
