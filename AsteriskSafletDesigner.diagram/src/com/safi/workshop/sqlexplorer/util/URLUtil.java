...
public class URLUtil {
  ...
  static private void init() {
    ...
    AsteriskDiagramEditorPlugin defaultPlugin = AsteriskDiagramEditorPlugin.getDefault();
   ...
   * 
   * @param yourPluginId
   *          e.g com.safi.workshop.sqlexplorer.oracle
   * @param filePath
   *          path to file within your fragment e.g. icons/test.gif
