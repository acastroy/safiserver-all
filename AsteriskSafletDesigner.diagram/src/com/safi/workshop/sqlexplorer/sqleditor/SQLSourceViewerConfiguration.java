...
public class SQLSourceViewerConfiguration extends SourceViewerConfiguration {
  ...
  /**
   * Creates a new SQL source viewer configuration for viewers in the given editor using
   * the given SQLTextTools.
   * 
   * @param tools
  ...
  public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
    ...
    // Register the same processor for strings and single line comments to get code
    // completion at the start of those partitions.
     ...
     * PROPOSALS_BACKGROUND, manager); assistant.setProposalSelectorBackground(c);
     * 
   ...
   * 
   * @see
   * org.eclipse.jface.text.source.SourceViewerConfiguration#getInformationPresenter(org
    ...
    if (iPresenter == null) {
      IInformationControlCreator informationControlCreator = new IInformationControlCreator() {
        public IInformationControl createInformationControl(Shell parent) {
          ...
          return new DefaultInformationControl(parent);// , SWT.RESIZE,, style, new
