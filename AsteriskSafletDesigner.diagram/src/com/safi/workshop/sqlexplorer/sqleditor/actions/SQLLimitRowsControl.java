...
/**
 * Class to add a "Limit Rows?" checkbox for the toolbar of SQLEditor; if checked, the
 * user is able to key in a number into a text field (default value is 100).
 * 
...
public class SQLLimitRowsControl extends ControlContribution {
   ...
   * 
   * @param editor
   *          the SQLEditor we're attached to
   */
   ...
   * 
   * @see
   * org.eclipse.jface.action.ControlContribution#createControl(org.eclipse.swt.widgets
   * .Composite)
   */
  @Override
  protected Control createControl(Composite parent) {
    ...
    maxResultField.setText(SQLExplorerPlugin.getDefault().getPreferenceStore().getString(
