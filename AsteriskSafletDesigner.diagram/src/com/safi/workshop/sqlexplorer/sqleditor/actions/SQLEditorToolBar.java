  ...
  private void doOnEditorSessionChanged(Session session) {
    ...
    try {
      ...
      if (metaDataSession != null)
        databaseProductName = metaDataSession.getDatabaseProductName().toLowerCase().trim();
      else
    ...
    for (IExtension e : extensions) {
      ...
      for (IConfigurationElement ce : ces) {
        try {
          ...
          AbstractEditorAction action = (AbstractEditorAction) ce
