...
/**
 * Abstract implementation for a sql editor actions. Extend this class to add new actions
 * to the sql editor.
 * 
      ...
      _editor.getSite().getShell().getDisplay().asyncExec(new Runnable() {
        public void run() {
          MessageDialog.openError(_editor.getSite().getShell(), Messages
              .getString("SQLResultsView.Error.InUseTitle"), Messages
              .getString("SQLResultsView.Error.InUse"));
        }
      });
      return null;
    }
