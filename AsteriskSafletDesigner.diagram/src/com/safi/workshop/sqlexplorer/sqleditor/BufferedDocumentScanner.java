...
/**
 * A buffered document scanner. The buffer always contains a section of a fixed size of
...
public final class BufferedDocumentScanner implements ICharacterScanner {
  ...
  /**
   * Creates a new buffered document scanner. The buffer size is set to the given number
   * of characters.
   * 
   * @param size
   *          the buffer size
