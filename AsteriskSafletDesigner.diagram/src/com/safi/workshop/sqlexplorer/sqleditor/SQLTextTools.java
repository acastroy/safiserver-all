...
/**
 * Tools required to configure a Java text viewer. The color manager and all scanner exist
 * only one time, i.e. the same instances are returned to all clients. Thus, clients share
 * those tools.
 * <p>
...
public class SQLTextTools {
  ...
  public SQLTextTools(IPreferenceStore store, Dictionary dictionary) {
    ...
    fMultilineCommentScanner = new SingleTokenSQLScanner(fColorManager, store,
        IConstants.SQL_COLOR_MULTILINE_COMMENT);
    fSinglelineCommentScanner = new SingleTokenSQLScanner(fColorManager, store,
        IConstants.SQL_COLOR_SINGLE_LINE_COMMENT);
    fStringScanner = new SingleTokenSQLScanner(fColorManager, store, IConstants.SQL_COLOR_STRING);
  ...
  public IDocumentPartitioner createDocumentPartitioner() {
    ...
    String[] types = new String[] { IDocument.DEFAULT_CONTENT_TYPE,
        IConstants.SQL_COLOR_MULTILINE_COMMENT, IConstants.SQL_COLOR_SINGLE_LINE_COMMENT,
   ...
   * behavior of one its contained components.
   * 
   * @param event
