...
public class ColumnLocatorPopup extends Shell {
  ...
  /**
   * Jump to next availabel column with header name. If the same name is processed again,
   * we jump to the next column with the same name. If no further columns are available,
   * we jump to first available column again.
   * 
   * @param name
   *          of column to jump to.
