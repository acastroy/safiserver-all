 ...
 * 
 * The Export to XLS option has been removed because it was simply outputting an HTML
 * table which Excel could read, and therefore provided little benefit over CSV. The
 * previous version used flags to indicate which fields were required, but the only
 * difference in usage was that CSV asked for delimiters but HTML and XLS did not. The
 * dialog now takes responsibility for asking for the desired export format and modifies
 * questions to suit.
 * 
 * @author Rocco Rutte <a href="mailto:pdmef@gmx.net">&lt;pdmef@gmx.net&gt;</a>.
 * @auther John Spackman <a
 *         href="mailto:john.spackman@zenesis.com">john.spackman@zenesis.com</a>
 * 
 */
public class ExportDlg extends TitleAreaDialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    boolean hdr = SQLExplorerPlugin.getDefault().getPreferenceStore().getBoolean(
  ...
  /**
   * Toggle accessibility of Ok button depending on whether all input is given. This
   * currently only depends on the filename being present.
   */
  private void sync() {
  ...
  /**
   * Return chosen character set. The underlying list is obtained from Character set, i.e.
   * it's valid.
   * 
