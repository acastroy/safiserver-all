...
public class SQLTextViewer extends SourceViewer {
  ...
  public SQLTextViewer(Composite parent, int style, IPreferenceStore store,
      final Dictionary dictionary, IVerticalRuler ruler) {
    ...
    String[] contentTypes = { IDocument.DEFAULT_CONTENT_TYPE,
        IConstants.SQL_COLOR_SINGLE_LINE_COMMENT, IConstants.SQL_COLOR_STRING,
   ...
   * 
   * @see
   * org.eclipse.jface.text.source.ISourceViewer#setDocument(org.eclipse.jface.text.IDocument
