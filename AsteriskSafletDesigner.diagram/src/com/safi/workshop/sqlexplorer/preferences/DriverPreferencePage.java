...
public class DriverPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
   ...
   * .Composite) The UI is defined in the DriverContainerGroup class. Note: The [Restore
   * Default] and [Apply] buttons have been removed using the noDefaultandApplyButton
   * method as these don't apply since all updates are made in the corresponding dialogs.
   */
  @Override
