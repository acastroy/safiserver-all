 ...
 * 
 * Derived classes must implement createFieldEditors() as usual, but where controls have
 * to be manually created (and loaded/saved from store), an instance of
...
public abstract class AbstractPreferencePage extends FieldEditorPreferencePage implements
  ...
  /*
   * Where FieldEditors cannot be used, an instance of Accessor is used to read and write
  ...
  protected static abstract class AbstractAccessor implements Accessor {
     ...
     * 
     * @param id
     *          preference ID represented the control
     * @param control
     *          the control
     */
   ...
   * 
   * @see
   * org.eclipse.jface.preference.FieldEditorPreferencePage#createContents(org.eclipse
