...
public class PropertyEditorDialog extends Dialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    final PropertyEditorTable propertyEditorTable = new PropertyEditorTable(container, SWT.NONE,
        propCopy);
  ...
  protected void configureShell(Shell newShell) {
    ...
    newShell.setImage(AsteriskDiagramEditorPlugin.getDefault().getBundledImage(
        "icons/common_tab.gif"));
    // newShell.setImage(ResourceManager.getPluginImage(AsteriskDiagramEditorPlugin.getDefault(),
    // "icons/common_tab.gif"));
    // newShell.setImage(ResourceManager.getPluginImage(AsteriskDiagramEditorPlugin.getDefault(),
    // "icons/common_tab.gif"));
