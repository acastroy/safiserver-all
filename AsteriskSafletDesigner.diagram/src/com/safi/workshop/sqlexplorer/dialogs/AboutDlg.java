...
class AboutItem {
  ...
  AboutItem(TabItem item, Composite parent) {
    ...
    final String version = Messages.getString("AboutDialog.About.versionPrefix")
        + SQLExplorerPlugin.getDefault().getVersion();
...
class CreditsItem {
  ...
  CreditsItem(TabItem item, Composite parent) {
    ...
    final String credits = "Developers (versions 3.5.0):" + separator
        + " - John Spackman (Zenesis Limited - www.zenesis.com)" + separator + separator
        + "Developers (versions 3.0.0):" + separator + " - Davy Vanherbergen" + separator
        + separator + "Developers (version 2.2.5 (never released)):" + separator
        + " - Alexandre Luti Telles" + separator + " - Davy Vanherbergen" + separator + separator
        + "Previous Developers (versions 2.2.3 and 2.2.4):" + separator
        + " - Alexandre Luti Telles" + separator + " - Gert Wohlgemuth" + separator + separator
        + "Other Contributors (versions 2.2.2 and before):" + separator
        + " - Andrea Mazzolini (original version of JFacedb)" + separator + " - Johan Compagner"
        + separator + " - Jouneau Luc" + separator + " - Stephen Schaub" + separator
        + " - Chris Potter (Sybase plugin, Sql Server plugin)" + separator
        + " - Joao Reis Belo (Sql Server plugin)" + separator + separator
        + "The SQL stuff is based on SquirreL SQL (http://squirrel-sql.sourceforge.net)."
        + separator + separator + "SQLExplorer uses the following libraries too:" + separator
