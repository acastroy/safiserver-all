...
public class EditUserDlg extends TitleAreaDialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    if (alias.getDriver() != null)
      driverName.setText(alias.getDriver().getId());
    else
      driverName.setText("");
  ...
  protected void okPressed() {
    ...
    if (userName.length() < 1) {
      MessageDialog.openError(getShell(), Messages.getString("EditUserDlg.MustGiveUsername.Title"),
          Messages.getString("EditUserDlg.MustGiveUsername.Message"));
      return;
    }
