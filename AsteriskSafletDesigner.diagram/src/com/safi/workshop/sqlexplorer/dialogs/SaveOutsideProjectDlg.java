...
/**
 * Dialog which prompts the user to warn them they are about to save outside a project and
 * that this is not normally a good idea. Allows the user to turn off further prompts
 * 
