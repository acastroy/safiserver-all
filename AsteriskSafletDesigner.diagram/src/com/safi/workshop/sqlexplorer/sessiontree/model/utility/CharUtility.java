...
class CharUtility {
  ...
  /**
   * Returns an int value that is negative if cCompare comes before cRef in the alphabet,
   * zero if the two are equal, and positive if cCompare comes after cRef in the alphabet.
   */
