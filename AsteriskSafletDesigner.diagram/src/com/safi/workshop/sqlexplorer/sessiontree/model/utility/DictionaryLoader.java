...
public class DictionaryLoader extends Job {
  ...
  private static final String ID = AsteriskDiagramEditorPlugin.ID;
  ...
  protected IStatus run(IProgressMonitor monitor) {
    ...
    try {
      ...
      return new Status(IStatus.CANCEL, ID, IStatus.CANCEL, Messages
          .getString("Progress.Dictionary.Cancelled"), null);

    } catch (Exception e) {
      return new Status(IStatus.ERROR, ID, IStatus.CANCEL, Messages
          .getString("Progress.Dictionary.Error"), e);
