...
class DoublyLinkedList {
    ...
    public Object next() {
      if (currentNextNode == null)
        throw new NoSuchElementException(
            "Attempt to retrieve next value from " + //$NON-NLS-1$
  ...
  /*
   * public static class Test { public static void main(String[] args) { DoublyLinkedList
   * testListOne = new DoublyLinkedList(); String testObjectOne = "test object one";
   * testListOne.addFirst(testObjectOne);
   * System.out.println("Size after adding one object by calling addFirst: " +
   * testListOne.size); testListOne.removeFirst();
   * System.out.println("Then called removeFirst and size is: " + testListOne.size);
   * 
   * testListOne.addLast(testObjectOne);
   * System.out.println("Size after adding one object by calling addLast: " +
   * testListOne.size); testListOne.removeLast();
   * System.out.println("Then called removeLast and size is: " + testListOne.size);
   * testListOne.clear(); testListOne.clear();
   * 
   * testListOne.addFirst(testObjectOne); DLLIterator iterator = testListOne.iterator();
   * System
   * .out.println("hasNext method of iterator after adding one object by calling addFirst: "
   * + iterator.hasNext());System.out.println(
   * "hasPrevious method of iterator after adding one object by calling addFirst: " +
   * iterator.hasPrevious()); String resultString = (String)iterator.next();
   * System.out.println("result string pulled out by calling next: " + resultString);
   * System.out.println("hasNext method of iterator after calling next: " +
   * iterator.hasNext());
   * System.out.println("hasPrevious method of iterator after calling next: " +
   * iterator.hasPrevious()); resultString = (String)iterator.previous();
   * System.out.println("result string pulled out by calling previous: " + resultString);
   * testListOne.clear();
   * 
   * System.out.println("");
   * 
   * String testObjectTwo = "test object two"; String testObjectThree =
   * "test object three";
   * 
   * testListOne.addFirst(testObjectTwo); testListOne.addFirst(testObjectOne);
   * iterator.resetToBeginning(); while(iterator.hasNext())
   * System.out.println((String)iterator.next()); testListOne.clear();
   * 
   * System.out.println("");
   * 
   * testListOne.addLast(testObjectOne); testListOne.addLast(testObjectTwo);
   * iterator.resetToBeginning(); while(iterator.hasNext())
   * System.out.println((String)iterator.next()); testListOne.clear();
   * 
   * System.out.println("");
   * 
   * testListOne.addFirst(testObjectThree); testListOne.addFirst(testObjectTwo);
   * testListOne.addFirst(testObjectOne); iterator.resetToBeginning();
   ...
   * 
   * testListOne.addLast(testObjectOne); testListOne.addLast(testObjectTwo);
   * testListOne.addLast(testObjectThree); iterator.resetToBeginning();
   * while(iterator.hasNext()) System.out.println((String)iterator.next());
   * testListOne.clear();
   * 
   * System.out.println("");
   * 
   * testListOne.addFirst(testObjectTwo); testListOne.addFirst(testObjectOne);
   * iterator.resetToEnd(); while(iterator.hasPrevious())
   * System.out.println((String)iterator.previous()); testListOne.clear();
   * 
   * System.out.println("");
   * 
   * testListOne.addFirst(testObjectThree); testListOne.addFirst(testObjectTwo);
