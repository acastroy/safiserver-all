package com.safi.workshop.sqlexplorer.filelist;
...
import com.safi.workshop.sqlexplorer.sqleditor.actions.SQLEditorSessionSwitcher;
...
public class FileListEditor extends EditorPart implements SwitchableSessionEditor {
  ...
  public void createPartControl(Composite parent) {
    ...
    mgr.add(new Action(Messages.getString("FileListEditor.Actions.Execute"), ImageUtil
        .getDescriptor("Images.ExecSQLIcon")) {
      @Override
      public void run() {
        execute();
      }
  ...
  protected void execute() {
    ...
    editor.getEditorSite().getShell().getDisplay().syncExec(new Runnable() {
      public void run() {
        IWorkbenchSiteProgressService siteps = (IWorkbenchSiteProgressService) editor
            .getEditorSite().getAdapter(IWorkbenchSiteProgressService.class);
