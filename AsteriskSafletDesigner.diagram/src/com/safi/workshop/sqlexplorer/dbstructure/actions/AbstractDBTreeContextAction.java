...
public abstract class AbstractDBTreeContextAction extends Action {
  ...
  /**
   * Implement this method to return true when your action is available for the selected
   * node(s). When true, the action will be included in the context menu, when false it
   * will be ignored.
   * 
   * 
  ...
  /**
   * Implement this method to return true when your action is the default action for the
   * selected node. When true, the action will be run when a double click on a node
   * occurs.
   * 
   * 
   * @return true if the action should be included in the context menu
