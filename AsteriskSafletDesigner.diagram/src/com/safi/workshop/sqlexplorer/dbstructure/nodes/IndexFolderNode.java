...
public class IndexFolderNode extends AbstractFolderNode {
  ...
  public IndexFolderNode(INode parent, ITableInfo tableInfo) {
    super(parent, Messages.getString("DatabaseStructureView.node.Indexes"), parent.getSession(),
        "index_folder");
  ...
  public void loadChildren() {
    ...
    try {
      ...
      while (it.hasNext()) {
        addChildNode(new IndexNode(this, it.next(), _session, (TableNode) getParent()));
      }
    } catch (Exception e) {
