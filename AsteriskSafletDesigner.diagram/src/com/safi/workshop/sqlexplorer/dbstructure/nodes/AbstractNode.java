...
public abstract class AbstractNode implements INode {
   ...
   * 
   * @see
   * com.safi.workshop.sqlexplorer.dbstructure.nodes.INode#fillDetailComposite(org.eclipse
  ...
  /**
   * Get an iterator to all child nodes. If child nodes haven't been loaded yet, loading
   * is triggered.
   * 
  ...
  /**
   * Get all the children of this node. If child nodes haven't been loaded yet, loading is
   * triggered.
   * 
   * @return All child nodes of this node.
   * @see com.safi.workshop.sqlexplorer.db.INode#getChildren()
   */
  ...
  /**
   * Override this method to change the text that is displayed in the database structure
   * outline for this node.
   */
   ...
   * @see com.safi.workshop.sqlexplorer.db.INode#getControlParent()
   */
  ...
  public String getSchemaOrCatalogName() {
    ...
    INode node = this;
    while (!(node.getType().equalsIgnoreCase("schema") || node.getType()
  ...
  /**
   * Implement this method to return a unique identifier for this node. It is used to
   * identify the node in the detail cache.
   * 
   * @see com.safi.workshop.sqlexplorer.dbstructure.nodes.INode#getUniqueIdentifier()
   */
  ...
  /**
   * Checks if this node has children. If child nodes haven't been loaded yet, this method
   * always returns true. This defers the loading of metadata used in the database
   * structure outline until it is actually required.
   * 
  ...
  /**
   * Returns true. Override this method to return false if your node cannot have any
   * children. This will avoid the twistie being displayed in the database structure
   * outline for nodes that cannot have children.
   * 
  ...
  /**
   * Load all the children of this node here. Do not call this method, but use load()
   * instead.
   */
  public abstract void loadChildren();

  /**
   * Refresh. This will clear the nodes' children and reload them. It will also update the
   * dictionary for this node & descendants
   */
