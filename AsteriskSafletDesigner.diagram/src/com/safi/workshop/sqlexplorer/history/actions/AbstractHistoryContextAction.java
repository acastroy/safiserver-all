...
/**
 * Abstract implementation for a context menu action of the SQL History View. Extend this
 * class to add new actions to the SQL History.
 * 
...
public abstract class AbstractHistoryContextAction extends Action {
  ...
  /**
   * Implement this method to return true when your action is enabled for the active
   * table. When true, the action will active in the context menu, when false it will
   * disabled
   * 
   * @return true if the action should be included in the context menu
   */
