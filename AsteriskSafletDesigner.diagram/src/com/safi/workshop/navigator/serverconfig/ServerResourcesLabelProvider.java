...
public class ServerResourcesLabelProvider extends LabelProvider {
  ...
  public Image getImage(Object element) {
    ...
    if (element instanceof AsteriskServerList) {
      if (((AsteriskServerList) element).debug) {
        if (this.debugAsteriskServersImage == null) {
          this.debugAsteriskServersImage = AsteriskDiagramEditorPlugin.getInstance()
              .getBundledImage("icons/server/resource/DebugAsteriskServers.gif");
        }
