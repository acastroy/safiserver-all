...
/**
 * A DeleteResourcesOperation represents an undoable operation for deleting one or more
 * resources in the workspace. Clients may call the public API from a background thread.
 * 
...
public class DeleteResourcesOperation extends AbstractResourcesOperation {
   ...
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#doExecute(org.eclipse.core.runtime
   ...
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#doUndo(org.eclipse.core.runtime
   * .IProgressMonitor, org.eclipse.core.runtime.IAdaptable)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#updateResourceChangeDescriptionFactory
   * (org.eclipse.core.resources.mapping.IResourceChangeDescriptionFactory, int)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * Map execution status to deletion status. Provide an extra warning if project content
   * is to be deleted.
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#computeExecutionStatus(org.eclipse
   ...
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#computeUndoableStatus(org.eclipse
   * .core.runtime.IProgressMonitor)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#computeRedoableStatus(org.eclipse
   * .core.runtime.IProgressMonitor)
   */
  @Override
  ...
  /*
   * Overridden so that projects whose contents are not to be deleted will not be checked.
   * A better solution would be to add API to ReadOnlyStateChecker to specify whether
   * project children should be checked, but it is too late to do that now. See
