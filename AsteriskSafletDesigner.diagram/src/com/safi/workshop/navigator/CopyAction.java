...
/* package */class CopyAction extends SelectionListenerAction {
  ...
  public void run() {
    ...
    IResource[] resources = (IResource[]) selectedResources.toArray(new IResource[selectedResources
        .size()]);
   ...
   * <code>SelectionListenerAction</code> method enables this action if one or more
   * resources of compatible types are selected.
   */
  @Override
