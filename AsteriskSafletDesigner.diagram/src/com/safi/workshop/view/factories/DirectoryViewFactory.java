...
import com.safi.workshop.edit.parts.DirectoryNameEditPart;
...
public class DirectoryViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(DirectoryEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(DirectoryNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
        getPreferencesHint());
  }
}
