...
import com.safi.workshop.edit.parts.RunQueryNameEditPart;
 ...
 * @generated
 */
public class RunQueryViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(RunQueryEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(RunQueryNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
        getPreferencesHint());
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(RunQueryRunQueryValuesPanelEditPart.VISUAL_ID),
