...
import com.safi.workshop.edit.parts.PickupEditPart;
import com.safi.workshop.edit.parts.PickupNameEditPart;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated
 */
public class PickupViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(PickupEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(PickupNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
        getPreferencesHint());
  }
}
