 ...
 * @generated
 */
public class GetColValuesValuesPanelViewFactory extends BasicNodeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(GetColValuesValuesPanelEditPart.VISUAL_ID);
