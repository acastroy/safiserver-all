...
import com.safi.workshop.edit.parts.ExtensionSpyNameEditPart;
 ...
 * @generated
 */
public class ExtensionSpyViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(ExtensionSpyEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(ExtensionSpyNameEditPart.VISUAL_ID), ViewUtil.APPEND,
