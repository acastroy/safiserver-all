...
import com.safi.workshop.edit.parts.GetFullVariableNameEditPart;
 ...
 * @generated
 */
public class GetFullVariableViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(GetFullVariableEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(GetFullVariableNameEditPart.VISUAL_ID), ViewUtil.APPEND,
