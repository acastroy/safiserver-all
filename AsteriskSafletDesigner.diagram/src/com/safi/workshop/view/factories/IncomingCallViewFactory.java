...
import com.safi.workshop.edit.parts.IncomingCallEditPart;
import com.safi.workshop.edit.parts.IncomingCallNameEditPart;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated
 */
public class IncomingCallViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(IncomingCallEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(IncomingCallNameEditPart.VISUAL_ID), ViewUtil.APPEND,
