 ...
 * @generated
 */
public class SetColValuesValuesPanelViewFactory extends BasicNodeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(SetColValuesValuesPanelEditPart.VISUAL_ID);
