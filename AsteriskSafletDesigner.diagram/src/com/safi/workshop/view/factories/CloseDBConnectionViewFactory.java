...
import com.safi.workshop.edit.parts.CloseDBConnectionNameEditPart;
 ...
 * @generated
 */
public class CloseDBConnectionViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(CloseDBConnectionEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(CloseDBConnectionNameEditPart.VISUAL_ID), ViewUtil.APPEND,
