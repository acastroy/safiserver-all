...
import com.safi.workshop.edit.parts.StopMixmonitorEditPart;
import com.safi.workshop.edit.parts.StopMixmonitorNameEditPart;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated
 */
public class StopMixmonitorViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(StopMixmonitorEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(StopMixmonitorNameEditPart.VISUAL_ID), ViewUtil.APPEND,
