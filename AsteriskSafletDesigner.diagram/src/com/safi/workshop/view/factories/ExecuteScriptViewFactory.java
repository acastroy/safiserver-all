...
import com.safi.workshop.edit.parts.ExecuteScriptNameEditPart;
 ...
 * @generated
 */
public class ExecuteScriptViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(ExecuteScriptEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(ExecuteScriptNameEditPart.VISUAL_ID), ViewUtil.APPEND,
