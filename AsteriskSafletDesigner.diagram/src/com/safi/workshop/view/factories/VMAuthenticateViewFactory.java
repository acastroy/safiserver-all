...
import com.safi.workshop.edit.parts.VMAuthenticateEditPart;
import com.safi.workshop.edit.parts.VMAuthenticateNameEditPart;
import com.safi.workshop.part.AsteriskVisualIDRegistry;

/**
 * @generated
 */
public class VMAuthenticateViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(VMAuthenticateEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(VMAuthenticateNameEditPart.VISUAL_ID), ViewUtil.APPEND,
