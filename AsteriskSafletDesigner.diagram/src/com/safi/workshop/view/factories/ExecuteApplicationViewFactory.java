...
import com.safi.workshop.edit.parts.ExecuteApplicationNameEditPart;
 ...
 * @generated
 */
public class ExecuteApplicationViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
    ...
    if (semanticHint == null) {
      semanticHint = AsteriskVisualIDRegistry.getType(ExecuteApplicationEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        AsteriskVisualIDRegistry.getType(ExecuteApplicationNameEditPart.VISUAL_ID),
