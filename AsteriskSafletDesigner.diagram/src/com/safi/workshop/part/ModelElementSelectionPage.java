...
public class ModelElementSelectionPage extends WizardPage {
  ...
  public void createControl(Composite parent) {
    ...
    modelVewer.setContentProvider(new AdapterFactoryContentProvider(AsteriskDiagramEditorPlugin
        .getInstance().getItemProvidersAdapterFactory()));
    modelVewer.setLabelProvider(new AdapterFactoryLabelProvider(AsteriskDiagramEditorPlugin
        .getInstance().getItemProvidersAdapterFactory()));
    if (selectedModelElement != null) {
      modelVewer.setInput(selectedModelElement.eResource());
      modelVewer.setSelection(new StructuredSelection(selectedModelElement));
