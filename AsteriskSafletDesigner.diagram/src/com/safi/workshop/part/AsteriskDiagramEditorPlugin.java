...
//        }
  ...
  /**
   * Respects images residing in any plug-in. If path is relative, then this bundle is
   * looked up for the image, otherwise, for absolute path, first segment is taken as id
   * of plug-in with image
   * 
   * @generated
   * @param path
   *          the path to image, either absolute (with plug-in id as first segment), or
  ...
  /**
   * Returns an image for the image file at the given plug-in relative path. Client do not
   * need to dispose this image. Images will be disposed automatically.
   * 
   * @generated
   * @param path
   *          the path
